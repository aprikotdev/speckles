...
// Package elements html param is generated from configuration file.
package elements
...
// Create a new ParamElement element. This will create a new element
...
func (e *ParamElement) BoolAttrRemove(name string) *ParamElement {
	if e.boolAttributes == nil {
		return e
	}
...
func (e *ParamElement) BoolAttrf(format string, args ...any) *ParamElement {
	return e.BoolAttr(fmt.Sprintf(format, args...))
}

func (e *ParamElement) IfBoolAttrf(condition bool, format string, args ...any) *ParamElement {
	if condition {
...
func (e *ParamElement) BoolAttrs(names ...string) *ParamElement {
...
func (e *ParamElement) IfBoolAttrs(condition bool, names ...string) *ParamElement {
	if condition {
		e.BoolAttrs(names...)
	}
	return e
...
func (e *ParamElement) IfAttr(condition bool, name, value string) *ParamElement {
	if condition {
		e.Attr(name, value)
	}
	return e
...
func (e *ParamElement) Attrf(name, format string, args ...any) *ParamElement {
	return e.Attr(name, fmt.Sprintf(format, args...))
}

func (e *ParamElement) IfAttrf(condition bool, name, format string, args ...any) *ParamElement {
	if condition {
...
func (e *ParamElement) IfAttrs(condition bool, attrs ...string) *ParamElement {
	if condition {
		e.Attrs(attrs...)
	}
	return e
...
func (e *ParamElement) IfAttrsMap(condition bool, attrs map[string]string) *ParamElement {
	if condition {
		e.AttrsMap(attrs)
	}
	return e
...
const (
	...
	ParamAutocapitalizeOff ParamAutocapitalizeChoice = "off"
	// Do not automatically capitalize any text.
	ParamAutocapitalizeNone ParamAutocapitalizeChoice = "none"
	// Automatically capitalize the first character of each sentence.
	ParamAutocapitalizeSentences ParamAutocapitalizeChoice = "sentences"
	// Automatically capitalize the first character of each sentence.
	ParamAutocapitalizeOn ParamAutocapitalizeChoice = "on"
	// Automatically capitalize the first character of each word.
	ParamAutocapitalizeWords ParamAutocapitalizeChoice = "words"
	// Automatically capitalize all characters.
	ParamAutocapitalizeCharacters ParamAutocapitalizeChoice = "characters"
)
...
// label, and the sighted user on a small device will equally miss the context
// created by the preceding content.
func (e *ParamElement) AutofocusIfRemove() *ParamElement {
	if e.boolAttributes == nil {
		return e
	}
	e.boolAttributes.Del("autofocus")
...
const (
	...
	ParamContenteditableEmpty ParamContenteditableChoice = ""
	// The element is editable.
	ParamContenteditableTrue ParamContenteditableChoice = "true"
	// The element is not editable.
	ParamContenteditableFalse ParamContenteditableChoice = "false"
	// which indicates that the element's raw text is editable, but rich text
	// formatting is disabled.
	ParamContenteditablePlaintextOnly ParamContenteditableChoice = "plaintext-only"
)
...
const (
	...
	ParamDirAuto ParamDirChoice = "auto"
)
...
const (
	...
	ParamDraggableTrue ParamDraggableChoice = "true"
	// The element is not draggable.
	ParamDraggableFalse ParamDraggableChoice = "false"
	...
	ParamDraggableEmpty ParamDraggableChoice = ""
	// drag behavior is the default browser behavior: only text selections, images,
	// and links can be dragged. For other elements, the event ondragstart must be
	// set for drag and drop to work
	ParamDraggableAuto ParamDraggableChoice = "auto"
)
...
const (
	...
	ParamHiddenEmpty ParamHiddenChoice = ""
	// set the element to the hidden state. Additionally, invalid values set the
	// element to the hidden state.
	ParamHiddenHidden ParamHiddenChoice = "hidden"
	...
	//
	ParamHiddenUntilFound ParamHiddenChoice = "until-found"
)
...
// focus. Hides the element and its content from assistive technologies by
// excluding them from the accessibility tree.
func (e *ParamElement) InertIfRemove() *ParamElement {
	if e.boolAttributes == nil {
		return e
	}
	e.boolAttributes.Del("inert")
...
const (
	...
	// control.
	ParamInputmodeNone ParamInputmodeChoice = "none"
	// Standard input keyboard for the user's current locale.
	ParamInputmodeEmpty ParamInputmodeChoice = ""
	// Standard input keyboard for the user's current locale.
	ParamInputmodeText ParamInputmodeChoice = "text"
	...
	// key (-).
	ParamInputmodeDecimal ParamInputmodeChoice = "decimal"
	// Numeric input keyboard, but only requires the digits 0–9. Devices may or
	// may not show a minus key.
	ParamInputmodeNumeric ParamInputmodeChoice = "numeric"
	...
	ParamInputmodeTel ParamInputmodeChoice = "tel"
	...
	// type="search"> instead.
	ParamInputmodeSearch ParamInputmodeChoice = "search"
	...
	ParamInputmodeEmail ParamInputmodeChoice = "email"
	...
	ParamInputmodeURL ParamInputmodeChoice = "url"
)
...
// range of elements including <audio>, <embed>, <iframe>, <img>, <link>,
// <object>, <source>, <track>, and <video>.
func (e *ParamElement) ItemscopeIfRemove() *ParamElement {
	if e.boolAttributes == nil {
		return e
	}
	e.boolAttributes.Del("itemscope")
...
const (
	...
	ParamPopoverAuto ParamPopoverChoice = "auto"
	// Popovers that have the auto state can be "light dismissed" by selecting
	// outside the popover area, and generally only allow one popover to be
	// displayed on-screen at a time.
	ParamPopoverEmpty ParamPopoverChoice = ""
	// manual popovers must always be explicitly hidden, but allow for use cases
	// such as nested popovers in menus.
	ParamPopoverManual ParamPopoverChoice = "manual"
)
...
const (
	...
	ParamSpellcheckEmpty ParamSpellcheckChoice = ""
	// The element will be checked for spelling errors.
	ParamSpellcheckTrue ParamSpellcheckChoice = "true"
	// The element will not be checked for spelling errors.
	ParamSpellcheckFalse ParamSpellcheckChoice = "false"
)
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *ParamElement) IfStyle(condition bool, s string) *ParamElement {
	if condition {
		e.Style(s)
	}
	return e
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *ParamElement) IfStyleAdd(condition bool, k string, v string) *ParamElement {
	if condition {
		e.StyleAdd(k, v)
	}
	return e
...
const (
	...
	ParamTranslateEmpty ParamTranslateChoice = ""
	// indicates that the element should be translated when the page is localized.
	ParamTranslateYes ParamTranslateChoice = "yes"
	// indicates that the element must not be translated when the page is localized.
	ParamTranslateNo ParamTranslateChoice = "no"
)
