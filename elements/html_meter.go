...
// Package elements html meter is generated from configuration file.
package elements
...
// Create a new MeterElement element. This will create a new element
...
func (e *MeterElement) BoolAttrRemove(name string) *MeterElement {
	if e.boolAttributes == nil {
		return e
	}
...
func (e *MeterElement) BoolAttrf(format string, args ...any) *MeterElement {
	return e.BoolAttr(fmt.Sprintf(format, args...))
}

func (e *MeterElement) IfBoolAttrf(condition bool, format string, args ...any) *MeterElement {
	if condition {
...
func (e *MeterElement) BoolAttrs(names ...string) *MeterElement {
...
func (e *MeterElement) IfBoolAttrs(condition bool, names ...string) *MeterElement {
	if condition {
		e.BoolAttrs(names...)
	}
	return e
...
func (e *MeterElement) IfAttr(condition bool, name, value string) *MeterElement {
	if condition {
		e.Attr(name, value)
	}
	return e
...
func (e *MeterElement) Attrf(name, format string, args ...any) *MeterElement {
	return e.Attr(name, fmt.Sprintf(format, args...))
}

func (e *MeterElement) IfAttrf(condition bool, name, format string, args ...any) *MeterElement {
	if condition {
...
func (e *MeterElement) IfAttrs(condition bool, attrs ...string) *MeterElement {
	if condition {
		e.Attrs(attrs...)
	}
	return e
...
func (e *MeterElement) IfAttrsMap(condition bool, attrs map[string]string) *MeterElement {
	if condition {
		e.AttrsMap(attrs)
	}
	return e
...
const (
	...
	MeterAutocapitalizeOff MeterAutocapitalizeChoice = "off"
	// Do not automatically capitalize any text.
	MeterAutocapitalizeNone MeterAutocapitalizeChoice = "none"
	// Automatically capitalize the first character of each sentence.
	MeterAutocapitalizeSentences MeterAutocapitalizeChoice = "sentences"
	// Automatically capitalize the first character of each sentence.
	MeterAutocapitalizeOn MeterAutocapitalizeChoice = "on"
	// Automatically capitalize the first character of each word.
	MeterAutocapitalizeWords MeterAutocapitalizeChoice = "words"
	// Automatically capitalize all characters.
	MeterAutocapitalizeCharacters MeterAutocapitalizeChoice = "characters"
)
...
// label, and the sighted user on a small device will equally miss the context
// created by the preceding content.
func (e *MeterElement) AutofocusIfRemove() *MeterElement {
	if e.boolAttributes == nil {
		return e
	}
	e.boolAttributes.Del("autofocus")
...
const (
	...
	MeterContenteditableEmpty MeterContenteditableChoice = ""
	// The element is editable.
	MeterContenteditableTrue MeterContenteditableChoice = "true"
	// The element is not editable.
	MeterContenteditableFalse MeterContenteditableChoice = "false"
	// which indicates that the element's raw text is editable, but rich text
	// formatting is disabled.
	MeterContenteditablePlaintextOnly MeterContenteditableChoice = "plaintext-only"
)
...
const (
	...
	MeterDirAuto MeterDirChoice = "auto"
)
...
const (
	...
	MeterDraggableTrue MeterDraggableChoice = "true"
	// The element is not draggable.
	MeterDraggableFalse MeterDraggableChoice = "false"
	...
	MeterDraggableEmpty MeterDraggableChoice = ""
	// drag behavior is the default browser behavior: only text selections, images,
	// and links can be dragged. For other elements, the event ondragstart must be
	// set for drag and drop to work
	MeterDraggableAuto MeterDraggableChoice = "auto"
)
...
const (
	...
	MeterHiddenEmpty MeterHiddenChoice = ""
	// set the element to the hidden state. Additionally, invalid values set the
	// element to the hidden state.
	MeterHiddenHidden MeterHiddenChoice = "hidden"
	...
	//
	MeterHiddenUntilFound MeterHiddenChoice = "until-found"
)
...
// focus. Hides the element and its content from assistive technologies by
// excluding them from the accessibility tree.
func (e *MeterElement) InertIfRemove() *MeterElement {
	if e.boolAttributes == nil {
		return e
	}
	e.boolAttributes.Del("inert")
...
const (
	...
	// control.
	MeterInputmodeNone MeterInputmodeChoice = "none"
	// Standard input keyboard for the user's current locale.
	MeterInputmodeEmpty MeterInputmodeChoice = ""
	// Standard input keyboard for the user's current locale.
	MeterInputmodeText MeterInputmodeChoice = "text"
	...
	// key (-).
	MeterInputmodeDecimal MeterInputmodeChoice = "decimal"
	// Numeric input keyboard, but only requires the digits 0–9. Devices may or
	// may not show a minus key.
	MeterInputmodeNumeric MeterInputmodeChoice = "numeric"
	...
	MeterInputmodeTel MeterInputmodeChoice = "tel"
	...
	// type="search"> instead.
	MeterInputmodeSearch MeterInputmodeChoice = "search"
	...
	MeterInputmodeEmail MeterInputmodeChoice = "email"
	...
	MeterInputmodeURL MeterInputmodeChoice = "url"
)
...
// range of elements including <audio>, <embed>, <iframe>, <img>, <link>,
// <object>, <source>, <track>, and <video>.
func (e *MeterElement) ItemscopeIfRemove() *MeterElement {
	if e.boolAttributes == nil {
		return e
	}
	e.boolAttributes.Del("itemscope")
...
const (
	...
	MeterPopoverAuto MeterPopoverChoice = "auto"
	// Popovers that have the auto state can be "light dismissed" by selecting
	// outside the popover area, and generally only allow one popover to be
	// displayed on-screen at a time.
	MeterPopoverEmpty MeterPopoverChoice = ""
	// manual popovers must always be explicitly hidden, but allow for use cases
	// such as nested popovers in menus.
	MeterPopoverManual MeterPopoverChoice = "manual"
)
...
const (
	...
	MeterSpellcheckEmpty MeterSpellcheckChoice = ""
	// The element will be checked for spelling errors.
	MeterSpellcheckTrue MeterSpellcheckChoice = "true"
	// The element will not be checked for spelling errors.
	MeterSpellcheckFalse MeterSpellcheckChoice = "false"
)
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *MeterElement) IfStyle(condition bool, s string) *MeterElement {
	if condition {
		e.Style(s)
	}
	return e
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *MeterElement) IfStyleAdd(condition bool, k string, v string) *MeterElement {
	if condition {
		e.StyleAdd(k, v)
	}
	return e
...
const (
	...
	MeterTranslateEmpty MeterTranslateChoice = ""
	// indicates that the element should be translated when the page is localized.
	MeterTranslateYes MeterTranslateChoice = "yes"
	// indicates that the element must not be translated when the page is localized.
	MeterTranslateNo MeterTranslateChoice = "no"
)
