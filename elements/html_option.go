...
// Package elements html option is generated from configuration file.
package elements
...
// Create a new OptionElement element. This will create a new element
// with the tag "option" during rendering.
...
func (e *OptionElement) BoolAttr(name string) *OptionElement {
...
func (e *OptionElement) BoolAttrRemove(name string) *OptionElement {
	if e.boolAttributes == nil {
		return e
	}
...
func (e *OptionElement) BoolAttrf(format string, args ...any) *OptionElement {
	return e.BoolAttr(fmt.Sprintf(format, args...))
}

func (e *OptionElement) IfBoolAttrf(condition bool, format string, args ...any) *OptionElement {
	if condition {
...
func (e *OptionElement) BoolAttrs(names ...string) *OptionElement {
...
func (e *OptionElement) IfBoolAttrs(condition bool, names ...string) *OptionElement {
	if condition {
		e.BoolAttrs(names...)
	}
	return e
...
func (e *OptionElement) Attr(name, value string) *OptionElement {
...
func (e *OptionElement) IfAttr(condition bool, name, value string) *OptionElement {
	if condition {
		e.Attr(name, value)
	}
	return e
...
func (e *OptionElement) Attrf(name, format string, args ...any) *OptionElement {
	return e.Attr(name, fmt.Sprintf(format, args...))
}

func (e *OptionElement) IfAttrf(condition bool, name, format string, args ...any) *OptionElement {
	if condition {
...
func (e *OptionElement) IfAttrs(condition bool, attrs ...string) *OptionElement {
	if condition {
		e.Attrs(attrs...)
	}
	return e
...
func (e *OptionElement) IfAttrsMap(condition bool, attrs map[string]string) *OptionElement {
	if condition {
		e.AttrsMap(attrs)
	}
	return e
...
// Remove the attribute Disabled from the element.
// Whether the form control is disabled.
func (e *OptionElement) DisabledIfRemove() *OptionElement {
	if e.boolAttributes == nil {
		return e
	}
	e.boolAttributes.Del("disabled")
...
func (e *OptionElement) LabelRemove() *OptionElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *OptionElement) Selected() *OptionElement {
	...
	e.boolAttributes.Set("selected", struct{}{})
	return e
}
...
// Remove the attribute Selected from the element.
// Whether the option is selected by default.
func (e *OptionElement) SelectedIfRemove() *OptionElement {
	if e.boolAttributes == nil {
		return e
	}
	e.boolAttributes.Del("selected")
...
func (e *OptionElement) ValueRemove() *OptionElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	OptionAutocapitalizeOff OptionAutocapitalizeChoice = "off"
	// Do not automatically capitalize any text.
	OptionAutocapitalizeNone OptionAutocapitalizeChoice = "none"
	// Automatically capitalize the first character of each sentence.
	OptionAutocapitalizeSentences OptionAutocapitalizeChoice = "sentences"
	// Automatically capitalize the first character of each sentence.
	OptionAutocapitalizeOn OptionAutocapitalizeChoice = "on"
	// Automatically capitalize the first character of each word.
	OptionAutocapitalizeWords OptionAutocapitalizeChoice = "words"
	// Automatically capitalize all characters.
	OptionAutocapitalizeCharacters OptionAutocapitalizeChoice = "characters"
)
...
func (e *OptionElement) AutocapitalizeRemove() *OptionElement {
	if e.stringAttributes == nil {
		return e
	}
...
// label, and the sighted user on a small device will equally miss the context
// created by the preceding content.
func (e *OptionElement) AutofocusIfRemove() *OptionElement {
	if e.boolAttributes == nil {
		return e
	}
	e.boolAttributes.Del("autofocus")
...
const (
	...
	OptionContenteditableEmpty OptionContenteditableChoice = ""
	// The element is editable.
	OptionContenteditableTrue OptionContenteditableChoice = "true"
	// The element is not editable.
	OptionContenteditableFalse OptionContenteditableChoice = "false"
	// which indicates that the element's raw text is editable, but rich text
	// formatting is disabled.
	OptionContenteditablePlaintextOnly OptionContenteditableChoice = "plaintext-only"
)
...
func (e *OptionElement) ContenteditableRemove() *OptionElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	OptionDirAuto OptionDirChoice = "auto"
)
...
func (e *OptionElement) DirRemove() *OptionElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	OptionDraggableTrue OptionDraggableChoice = "true"
	// The element is not draggable.
	OptionDraggableFalse OptionDraggableChoice = "false"
	...
	OptionDraggableEmpty OptionDraggableChoice = ""
	// drag behavior is the default browser behavior: only text selections, images,
	// and links can be dragged. For other elements, the event ondragstart must be
	// set for drag and drop to work
	OptionDraggableAuto OptionDraggableChoice = "auto"
)
...
func (e *OptionElement) DraggableRemove() *OptionElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	OptionEnterkeyhintEnter OptionEnterkeyhintChoice = "enter"
	// Typically meaning there is nothing more to input and the input method editor
	// (IME) will be closed.
	OptionEnterkeyhintDone OptionEnterkeyhintChoice = "done"
	// Typically meaning to take the user to the target of the text they typed.
	OptionEnterkeyhintGo OptionEnterkeyhintChoice = "go"
	// Typically meaning to take the user to the next field that will accept text.
	OptionEnterkeyhintNext OptionEnterkeyhintChoice = "next"
	// Typically meaning to take the user to the previous field that will accept
	// text.
	OptionEnterkeyhintPrevious OptionEnterkeyhintChoice = "previous"
	// Typically taking the user to the results of searching for the text they have
	// typed.
	OptionEnterkeyhintSearch OptionEnterkeyhintChoice = "search"
	// Typically delivering the text to its target.
	OptionEnterkeyhintSend OptionEnterkeyhintChoice = "send"
)

// The enterkeyhint global Attribute is an enumerated attribute defining what
// action label (or icon) to present for the enter key on virtual keyboards.
// Remove the attribute Enterkeyhint from the element.
func (e *OptionElement) EnterkeyhintRemove() *OptionElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	OptionHiddenEmpty OptionHiddenChoice = ""
	// set the element to the hidden state. Additionally, invalid values set the
	// element to the hidden state.
	OptionHiddenHidden OptionHiddenChoice = "hidden"
	...
	//
	OptionHiddenUntilFound OptionHiddenChoice = "until-found"
)
...
func (e *OptionElement) HiddenRemove() *OptionElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *OptionElement) IDRemove() *OptionElement {
	if e.stringAttributes == nil {
		return e
	}
...
// focus. Hides the element and its content from assistive technologies by
// excluding them from the accessibility tree.
func (e *OptionElement) InertIfRemove() *OptionElement {
	if e.boolAttributes == nil {
		return e
	}
	e.boolAttributes.Del("inert")
...
const (
	...
	// control.
	OptionInputmodeNone OptionInputmodeChoice = "none"
	// Standard input keyboard for the user's current locale.
	OptionInputmodeEmpty OptionInputmodeChoice = ""
	// Standard input keyboard for the user's current locale.
	OptionInputmodeText OptionInputmodeChoice = "text"
	...
	// key (-).
	OptionInputmodeDecimal OptionInputmodeChoice = "decimal"
	// Numeric input keyboard, but only requires the digits 0–9. Devices may or
	// may not show a minus key.
	OptionInputmodeNumeric OptionInputmodeChoice = "numeric"
	...
	OptionInputmodeTel OptionInputmodeChoice = "tel"
	...
	// type="search"> instead.
	OptionInputmodeSearch OptionInputmodeChoice = "search"
	...
	OptionInputmodeEmail OptionInputmodeChoice = "email"
	...
	OptionInputmodeURL OptionInputmodeChoice = "url"
)
...
func (e *OptionElement) InputmodeRemove() *OptionElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *OptionElement) IsRemove() *OptionElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *OptionElement) ItemidRemove() *OptionElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *OptionElement) ItempropRemove() *OptionElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *OptionElement) ItemrefRemove() *OptionElement {
	if e.stringAttributes == nil {
		return e
	}
...
// range of elements including <audio>, <embed>, <iframe>, <img>, <link>,
// <object>, <source>, <track>, and <video>.
func (e *OptionElement) ItemscopeIfRemove() *OptionElement {
	if e.boolAttributes == nil {
		return e
	}
	e.boolAttributes.Del("itemscope")
...
func (e *OptionElement) ItemtypeRemove() *OptionElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *OptionElement) LangRemove() *OptionElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *OptionElement) NonceRemove() *OptionElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	OptionPopoverAuto OptionPopoverChoice = "auto"
	// Popovers that have the auto state can be "light dismissed" by selecting
	// outside the popover area, and generally only allow one popover to be
	// displayed on-screen at a time.
	OptionPopoverEmpty OptionPopoverChoice = ""
	// manual popovers must always be explicitly hidden, but allow for use cases
	// such as nested popovers in menus.
	OptionPopoverManual OptionPopoverChoice = "manual"
)
...
func (e *OptionElement) PopoverRemove() *OptionElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *OptionElement) RoleRemove() *OptionElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *OptionElement) SlotRemove() *OptionElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	OptionSpellcheckEmpty OptionSpellcheckChoice = ""
	// The element will be checked for spelling errors.
	OptionSpellcheckTrue OptionSpellcheckChoice = "true"
	// The element will not be checked for spelling errors.
	OptionSpellcheckFalse OptionSpellcheckChoice = "false"
)
...
func (e *OptionElement) SpellcheckRemove() *OptionElement {
	if e.stringAttributes == nil {
		return e
	}
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *OptionElement) IfStyle(condition bool, s string) *OptionElement {
	if condition {
		e.Style(s)
	}
	return e
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *OptionElement) StyleAdd(k string, v string) *OptionElement {
	if e.keyValueStrings == nil {
		e.keyValueStrings = treemap.New[string, *keyValueBuilder]()
	}
	_, ok := e.keyValueStrings.Get("style")
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *OptionElement) IfStyleAdd(condition bool, k string, v string) *OptionElement {
	if condition {
		e.StyleAdd(k, v)
	}
	return e
...
func (e *OptionElement) TabindexRemove() *OptionElement {
	if e.intAttributes == nil {
		return e
	}
...
func (e *OptionElement) TitleRemove() *OptionElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	OptionTranslateEmpty OptionTranslateChoice = ""
	// indicates that the element should be translated when the page is localized.
	OptionTranslateYes OptionTranslateChoice = "yes"
	// indicates that the element must not be translated when the page is localized.
	OptionTranslateNo OptionTranslateChoice = "no"
)
...
func (e *OptionElement) TranslateRemove() *OptionElement {
	if e.stringAttributes == nil {
		return e
	}
