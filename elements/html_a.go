...
// Package elements html a is generated from configuration file.
package elements
...
// or anything else a URL can address. Content within each <a> should indicate
// the link's destination.
type AElement struct {
	*Element
}

// Create a new AElement element. This will create a new element
...
func (e *AElement) BoolAttr(name string) *AElement {
...
func (e *AElement) BoolAttrRemove(name string) *AElement {
	if e.boolAttributes == nil {
		return e
	}
...
func (e *AElement) IfBoolAttr(condition bool, name string) *AElement {
	if condition {
		e.BoolAttr(name)
	}
	return e
...
func (e *AElement) BoolAttrf(format string, args ...any) *AElement {
	return e.BoolAttr(fmt.Sprintf(format, args...))
}

func (e *AElement) IfBoolAttrf(condition bool, format string, args ...any) *AElement {
	if condition {
...
func (e *AElement) BoolAttrs(names ...string) *AElement {
...
func (e *AElement) IfBoolAttrs(condition bool, names ...string) *AElement {
	if condition {
		e.BoolAttrs(names...)
	}
	return e
...
func (e *AElement) Attr(name, value string) *AElement {
...
func (e *AElement) IfAttr(condition bool, name, value string) *AElement {
	if condition {
		e.Attr(name, value)
	}
	return e
...
func (e *AElement) Attrf(name, format string, args ...any) *AElement {
	return e.Attr(name, fmt.Sprintf(format, args...))
}

func (e *AElement) IfAttrf(condition bool, name, format string, args ...any) *AElement {
	if condition {
...
func (e *AElement) IfAttrs(condition bool, attrs ...string) *AElement {
	if condition {
		e.Attrs(attrs...)
	}
	return e
...
func (e *AElement) IfAttrsMap(condition bool, attrs map[string]string) *AElement {
	if condition {
		e.AttrsMap(attrs)
	}
	return e
...
func (e *AElement) DownloadRemove() *AElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *AElement) HrefRemove() *AElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *AElement) HreflangRemove() *AElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	AReferrerpolicyNoReferrer AReferrerpolicyChoice = "no-referrer"
	// The Referer header will not be sent to origins without TLS (HTTPS).
	AReferrerpolicyNoReferrerWhenDowngrade AReferrerpolicyChoice = "no-referrer-when-downgrade"
	// The Referer header will be the origin of the page.
	AReferrerpolicyOrigin AReferrerpolicyChoice = "origin"
	// The Referer header will be the origin of the page for same-origin requests,
	// and the full URL for cross-origin requests.
	AReferrerpolicyOriginWhenCrossOrigin AReferrerpolicyChoice = "origin-when-cross-origin"
	// The Referer header will be sent for same-origin requests, but cross-origin
	// requests will contain no Referer header.
	AReferrerpolicySameOrigin AReferrerpolicyChoice = "same-origin"
	// The Referer header will be sent with same-origin requests, but cross-origin
	// requests will contain no Referer header.
	AReferrerpolicyStrictOrigin AReferrerpolicyChoice = "strict-origin"
	...
	AReferrerpolicyStrictOriginWhenCrossOrigin AReferrerpolicyChoice = "strict-origin-when-cross-origin"
	// The Referer header will be sent with same-origin and cross-origin requests.
	AReferrerpolicyUnsafeURL AReferrerpolicyChoice = "unsafe-url"
)

// Specifies which referrer to send when fetching the resource. See
// Referrer-Policy for possible values and their effects.
// Remove the attribute Referrerpolicy from the element.
func (e *AElement) ReferrerpolicyRemove() *AElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *AElement) TargetRemove() *AElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *AElement) TypeRemove() *AElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	AAutocapitalizeOff AAutocapitalizeChoice = "off"
	// Do not automatically capitalize any text.
	AAutocapitalizeNone AAutocapitalizeChoice = "none"
	// Automatically capitalize the first character of each sentence.
	AAutocapitalizeSentences AAutocapitalizeChoice = "sentences"
	// Automatically capitalize the first character of each sentence.
	AAutocapitalizeOn AAutocapitalizeChoice = "on"
	// Automatically capitalize the first character of each word.
	AAutocapitalizeWords AAutocapitalizeChoice = "words"
	// Automatically capitalize all characters.
	AAutocapitalizeCharacters AAutocapitalizeChoice = "characters"
)
...
func (e *AElement) AutocapitalizeRemove() *AElement {
	if e.stringAttributes == nil {
		return e
	}
...
// label, and the sighted user on a small device will equally miss the context
// created by the preceding content.
func (e *AElement) AutofocusRemove() *AElement {
	if e.boolAttributes == nil {
		return e
	}
...
// label, and the sighted user on a small device will equally miss the context
// created by the preceding content.
func (e *AElement) AutofocusIfRemove() *AElement {
	if e.boolAttributes == nil {
		return e
	}
	e.boolAttributes.Del("autofocus")
...
const (
	...
	AContenteditableEmpty AContenteditableChoice = ""
	// The element is editable.
	AContenteditableTrue AContenteditableChoice = "true"
	// The element is not editable.
	AContenteditableFalse AContenteditableChoice = "false"
	// which indicates that the element's raw text is editable, but rich text
	// formatting is disabled.
	AContenteditablePlaintextOnly AContenteditableChoice = "plaintext-only"
)
...
func (e *AElement) ContenteditableRemove() *AElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *AElement) DirRemove() *AElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	ADraggableTrue ADraggableChoice = "true"
	// The element is not draggable.
	ADraggableFalse ADraggableChoice = "false"
	...
	ADraggableEmpty ADraggableChoice = ""
	// drag behavior is the default browser behavior: only text selections, images,
	// and links can be dragged. For other elements, the event ondragstart must be
	// set for drag and drop to work
	ADraggableAuto ADraggableChoice = "auto"
)
...
func (e *AElement) DraggableRemove() *AElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	AHiddenEmpty AHiddenChoice = ""
	// set the element to the hidden state. Additionally, invalid values set the
	// element to the hidden state.
	AHiddenHidden AHiddenChoice = "hidden"
	...
	//
	AHiddenUntilFound AHiddenChoice = "until-found"
)
...
func (e *AElement) HiddenRemove() *AElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *AElement) IDRemove() *AElement {
	if e.stringAttributes == nil {
		return e
	}
...
// focus. Hides the element and its content from assistive technologies by
// excluding them from the accessibility tree.
func (e *AElement) InertRemove() *AElement {
	if e.boolAttributes == nil {
		return e
	}
...
// focus. Hides the element and its content from assistive technologies by
// excluding them from the accessibility tree.
func (e *AElement) InertIfRemove() *AElement {
	if e.boolAttributes == nil {
		return e
	}
	e.boolAttributes.Del("inert")
...
const (
	...
	// control.
	AInputmodeNone AInputmodeChoice = "none"
	// Standard input keyboard for the user's current locale.
	AInputmodeEmpty AInputmodeChoice = ""
	// Standard input keyboard for the user's current locale.
	AInputmodeText AInputmodeChoice = "text"
	...
	AInputmodeTel AInputmodeChoice = "tel"
	...
	// type="search"> instead.
	AInputmodeSearch AInputmodeChoice = "search"
	...
	AInputmodeEmail AInputmodeChoice = "email"
	...
	AInputmodeURL AInputmodeChoice = "url"
)
...
func (e *AElement) InputmodeRemove() *AElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *AElement) IsRemove() *AElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *AElement) ItemidRemove() *AElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *AElement) ItempropRemove() *AElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *AElement) ItemrefRemove() *AElement {
	if e.stringAttributes == nil {
		return e
	}
...
// range of elements including <audio>, <embed>, <iframe>, <img>, <link>,
// <object>, <source>, <track>, and <video>.
func (e *AElement) ItemscopeRemove() *AElement {
	if e.boolAttributes == nil {
		return e
	}
...
// range of elements including <audio>, <embed>, <iframe>, <img>, <link>,
// <object>, <source>, <track>, and <video>.
func (e *AElement) ItemscopeIfRemove() *AElement {
	if e.boolAttributes == nil {
		return e
	}
	e.boolAttributes.Del("itemscope")
...
func (e *AElement) ItemtypeRemove() *AElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *AElement) LangRemove() *AElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *AElement) NonceRemove() *AElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *AElement) PopoverRemove() *AElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *AElement) RoleRemove() *AElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *AElement) SlotRemove() *AElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	ASpellcheckEmpty ASpellcheckChoice = ""
	// The element will be checked for spelling errors.
	ASpellcheckTrue ASpellcheckChoice = "true"
	// The element will not be checked for spelling errors.
	ASpellcheckFalse ASpellcheckChoice = "false"
)
...
func (e *AElement) SpellcheckRemove() *AElement {
	if e.stringAttributes == nil {
		return e
	}
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *AElement) IfStyle(condition bool, s string) *AElement {
	if condition {
		e.Style(s)
	}
	return e
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *AElement) StyleAdd(k string, v string) *AElement {
	if e.keyValueStrings == nil {
		e.keyValueStrings = treemap.New[string, *keyValueBuilder]()
	}
	_, ok := e.keyValueStrings.Get("style")
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *AElement) IfStyleAdd(condition bool, k string, v string) *AElement {
	if condition {
		e.StyleAdd(k, v)
	}
	return e
...
func (e *AElement) TabindexRemove() *AElement {
	if e.intAttributes == nil {
		return e
	}
...
func (e *AElement) TitleRemove() *AElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	ATranslateEmpty ATranslateChoice = ""
	// indicates that the element should be translated when the page is localized.
	ATranslateYes ATranslateChoice = "yes"
	// indicates that the element must not be translated when the page is localized.
	ATranslateNo ATranslateChoice = "no"
)
...
func (e *AElement) TranslateRemove() *AElement {
	if e.stringAttributes == nil {
		return e
	}
