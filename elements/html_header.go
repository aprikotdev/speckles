...
// Package elements html header is generated from configuration file.
package elements
...
// The HTML <header> element represents introductory content, typically a group
...
// Create a new HeaderElement element. This will create a new element
// with the tag "header" during rendering.
...
func (e *HeaderElement) BoolAttrRemove(name string) *HeaderElement {
	if e.boolAttributes == nil {
		return e
	}
...
func (e *HeaderElement) BoolAttrf(format string, args ...any) *HeaderElement {
	return e.BoolAttr(fmt.Sprintf(format, args...))
}

func (e *HeaderElement) IfBoolAttrf(condition bool, format string, args ...any) *HeaderElement {
	if condition {
...
func (e *HeaderElement) BoolAttrs(names ...string) *HeaderElement {
...
func (e *HeaderElement) IfBoolAttrs(condition bool, names ...string) *HeaderElement {
	if condition {
		e.BoolAttrs(names...)
	}
	return e
...
func (e *HeaderElement) Attrf(name, format string, args ...any) *HeaderElement {
	return e.Attr(name, fmt.Sprintf(format, args...))
}

func (e *HeaderElement) IfAttrf(condition bool, name, format string, args ...any) *HeaderElement {
	if condition {
...
func (e *HeaderElement) IfAttrs(condition bool, attrs ...string) *HeaderElement {
	if condition {
		e.Attrs(attrs...)
	}
	return e
...
func (e *HeaderElement) IfAttrsMap(condition bool, attrs map[string]string) *HeaderElement {
	if condition {
		e.AttrsMap(attrs)
	}
	return e
...
const (
	...
	HeaderAutocapitalizeOff HeaderAutocapitalizeChoice = "off"
	// Do not automatically capitalize any text.
	HeaderAutocapitalizeNone HeaderAutocapitalizeChoice = "none"
	// Automatically capitalize the first character of each sentence.
	HeaderAutocapitalizeSentences HeaderAutocapitalizeChoice = "sentences"
	// Automatically capitalize the first character of each sentence.
	HeaderAutocapitalizeOn HeaderAutocapitalizeChoice = "on"
	// Automatically capitalize the first character of each word.
	HeaderAutocapitalizeWords HeaderAutocapitalizeChoice = "words"
	// Automatically capitalize all characters.
	HeaderAutocapitalizeCharacters HeaderAutocapitalizeChoice = "characters"
)
...
func (e *HeaderElement) AutocapitalizeRemove() *HeaderElement {
	if e.stringAttributes == nil {
		return e
	}
...
// label, and the sighted user on a small device will equally miss the context
// created by the preceding content.
func (e *HeaderElement) AutofocusRemove() *HeaderElement {
	if e.boolAttributes == nil {
		return e
	}
...
// label, and the sighted user on a small device will equally miss the context
// created by the preceding content.
func (e *HeaderElement) AutofocusIfRemove() *HeaderElement {
	if e.boolAttributes == nil {
		return e
	}
	e.boolAttributes.Del("autofocus")
...
const (
	...
	HeaderContenteditableEmpty HeaderContenteditableChoice = ""
	// The element is editable.
	HeaderContenteditableTrue HeaderContenteditableChoice = "true"
	// The element is not editable.
	HeaderContenteditableFalse HeaderContenteditableChoice = "false"
	// which indicates that the element's raw text is editable, but rich text
	// formatting is disabled.
	HeaderContenteditablePlaintextOnly HeaderContenteditableChoice = "plaintext-only"
)
...
func (e *HeaderElement) ContenteditableRemove() *HeaderElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	HeaderDirAuto HeaderDirChoice = "auto"
)
...
func (e *HeaderElement) DirRemove() *HeaderElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	HeaderDraggableTrue HeaderDraggableChoice = "true"
	// The element is not draggable.
	HeaderDraggableFalse HeaderDraggableChoice = "false"
	...
	HeaderDraggableEmpty HeaderDraggableChoice = ""
	// drag behavior is the default browser behavior: only text selections, images,
	// and links can be dragged. For other elements, the event ondragstart must be
	// set for drag and drop to work
	HeaderDraggableAuto HeaderDraggableChoice = "auto"
)
...
func (e *HeaderElement) DraggableRemove() *HeaderElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	HeaderEnterkeyhintEnter HeaderEnterkeyhintChoice = "enter"
	// Typically meaning there is nothing more to input and the input method editor
	// (IME) will be closed.
	HeaderEnterkeyhintDone HeaderEnterkeyhintChoice = "done"
	// Typically meaning to take the user to the target of the text they typed.
	HeaderEnterkeyhintGo HeaderEnterkeyhintChoice = "go"
	// Typically meaning to take the user to the next field that will accept text.
	HeaderEnterkeyhintNext HeaderEnterkeyhintChoice = "next"
	// Typically meaning to take the user to the previous field that will accept
	// text.
	HeaderEnterkeyhintPrevious HeaderEnterkeyhintChoice = "previous"
	// Typically taking the user to the results of searching for the text they have
	// typed.
	HeaderEnterkeyhintSearch HeaderEnterkeyhintChoice = "search"
	// Typically delivering the text to its target.
	HeaderEnterkeyhintSend HeaderEnterkeyhintChoice = "send"
)

// The enterkeyhint global Attribute is an enumerated attribute defining what
// action label (or icon) to present for the enter key on virtual keyboards.
// Remove the attribute Enterkeyhint from the element.
func (e *HeaderElement) EnterkeyhintRemove() *HeaderElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	HeaderHiddenEmpty HeaderHiddenChoice = ""
	// set the element to the hidden state. Additionally, invalid values set the
	// element to the hidden state.
	HeaderHiddenHidden HeaderHiddenChoice = "hidden"
	...
	//
	HeaderHiddenUntilFound HeaderHiddenChoice = "until-found"
)
...
func (e *HeaderElement) HiddenRemove() *HeaderElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *HeaderElement) IDRemove() *HeaderElement {
	if e.stringAttributes == nil {
		return e
	}
...
// focus. Hides the element and its content from assistive technologies by
// excluding them from the accessibility tree.
func (e *HeaderElement) InertRemove() *HeaderElement {
	if e.boolAttributes == nil {
		return e
	}
...
// focus. Hides the element and its content from assistive technologies by
// excluding them from the accessibility tree.
func (e *HeaderElement) InertIfRemove() *HeaderElement {
	if e.boolAttributes == nil {
		return e
	}
	e.boolAttributes.Del("inert")
...
const (
	...
	// control.
	HeaderInputmodeNone HeaderInputmodeChoice = "none"
	// Standard input keyboard for the user's current locale.
	HeaderInputmodeEmpty HeaderInputmodeChoice = ""
	// Standard input keyboard for the user's current locale.
	HeaderInputmodeText HeaderInputmodeChoice = "text"
	...
	// key (-).
	HeaderInputmodeDecimal HeaderInputmodeChoice = "decimal"
	// Numeric input keyboard, but only requires the digits 0–9. Devices may or
	// may not show a minus key.
	HeaderInputmodeNumeric HeaderInputmodeChoice = "numeric"
	...
	HeaderInputmodeTel HeaderInputmodeChoice = "tel"
	...
	// type="search"> instead.
	HeaderInputmodeSearch HeaderInputmodeChoice = "search"
	...
	HeaderInputmodeEmail HeaderInputmodeChoice = "email"
	...
	HeaderInputmodeURL HeaderInputmodeChoice = "url"
)
...
func (e *HeaderElement) InputmodeRemove() *HeaderElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *HeaderElement) IsRemove() *HeaderElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *HeaderElement) ItemidRemove() *HeaderElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *HeaderElement) ItempropRemove() *HeaderElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *HeaderElement) ItemrefRemove() *HeaderElement {
	if e.stringAttributes == nil {
		return e
	}
...
// range of elements including <audio>, <embed>, <iframe>, <img>, <link>,
// <object>, <source>, <track>, and <video>.
func (e *HeaderElement) ItemscopeRemove() *HeaderElement {
	if e.boolAttributes == nil {
		return e
	}
...
// range of elements including <audio>, <embed>, <iframe>, <img>, <link>,
// <object>, <source>, <track>, and <video>.
func (e *HeaderElement) ItemscopeIfRemove() *HeaderElement {
	if e.boolAttributes == nil {
		return e
	}
	e.boolAttributes.Del("itemscope")
...
func (e *HeaderElement) ItemtypeRemove() *HeaderElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *HeaderElement) LangRemove() *HeaderElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *HeaderElement) NonceRemove() *HeaderElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	HeaderPopoverAuto HeaderPopoverChoice = "auto"
	// Popovers that have the auto state can be "light dismissed" by selecting
	// outside the popover area, and generally only allow one popover to be
	// displayed on-screen at a time.
	HeaderPopoverEmpty HeaderPopoverChoice = ""
	// manual popovers must always be explicitly hidden, but allow for use cases
	// such as nested popovers in menus.
	HeaderPopoverManual HeaderPopoverChoice = "manual"
)
...
func (e *HeaderElement) PopoverRemove() *HeaderElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *HeaderElement) RoleRemove() *HeaderElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *HeaderElement) SlotRemove() *HeaderElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	HeaderSpellcheckEmpty HeaderSpellcheckChoice = ""
	// The element will be checked for spelling errors.
	HeaderSpellcheckTrue HeaderSpellcheckChoice = "true"
	// The element will not be checked for spelling errors.
	HeaderSpellcheckFalse HeaderSpellcheckChoice = "false"
)
...
func (e *HeaderElement) SpellcheckRemove() *HeaderElement {
	if e.stringAttributes == nil {
		return e
	}
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *HeaderElement) IfStyle(condition bool, s string) *HeaderElement {
	if condition {
		e.Style(s)
	}
	return e
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *HeaderElement) StyleAdd(k string, v string) *HeaderElement {
	if e.keyValueStrings == nil {
		e.keyValueStrings = treemap.New[string, *keyValueBuilder]()
	}
	_, ok := e.keyValueStrings.Get("style")
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *HeaderElement) StyleAddf(k string, format string, args ...any) *HeaderElement {
	return e.StyleAdd(k, fmt.Sprintf(format, args...))
}

// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *HeaderElement) IfStyleAdd(condition bool, k string, v string) *HeaderElement {
	if condition {
		e.StyleAdd(k, v)
	}
	return e
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *HeaderElement) IfStyleAddf(condition bool, k string, format string, args ...any) *HeaderElement {
	if condition {
...
func (e *HeaderElement) TabindexRemove() *HeaderElement {
	if e.intAttributes == nil {
		return e
	}
...
func (e *HeaderElement) TitleRemove() *HeaderElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	HeaderTranslateEmpty HeaderTranslateChoice = ""
	// indicates that the element should be translated when the page is localized.
	HeaderTranslateYes HeaderTranslateChoice = "yes"
	// indicates that the element must not be translated when the page is localized.
	HeaderTranslateNo HeaderTranslateChoice = "no"
)
...
func (e *HeaderElement) TranslateRemove() *HeaderElement {
	if e.stringAttributes == nil {
		return e
	}
