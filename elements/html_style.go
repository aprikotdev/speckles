...
// Package elements html style is generated from configuration file.
package elements
...
// of a document. By default, the style instructions written inside that element
// are expected to be CSS.
type StyleElement struct {
	*Element
}

// Create a new StyleElement element. This will create a new element
...
func (e *StyleElement) BoolAttr(name string) *StyleElement {
...
func (e *StyleElement) BoolAttrRemove(name string) *StyleElement {
	if e.boolAttributes == nil {
		return e
	}
...
func (e *StyleElement) BoolAttrf(format string, args ...any) *StyleElement {
	return e.BoolAttr(fmt.Sprintf(format, args...))
}

func (e *StyleElement) IfBoolAttrf(condition bool, format string, args ...any) *StyleElement {
	if condition {
...
func (e *StyleElement) BoolAttrs(names ...string) *StyleElement {
...
func (e *StyleElement) IfBoolAttrs(condition bool, names ...string) *StyleElement {
	if condition {
		e.BoolAttrs(names...)
	}
	return e
...
func (e *StyleElement) Attr(name, value string) *StyleElement {
...
func (e *StyleElement) IfAttr(condition bool, name, value string) *StyleElement {
	if condition {
		e.Attr(name, value)
	}
	return e
...
func (e *StyleElement) Attrf(name, format string, args ...any) *StyleElement {
	return e.Attr(name, fmt.Sprintf(format, args...))
}

func (e *StyleElement) IfAttrf(condition bool, name, format string, args ...any) *StyleElement {
	if condition {
...
func (e *StyleElement) IfAttrs(condition bool, attrs ...string) *StyleElement {
	if condition {
		e.Attrs(attrs...)
	}
	return e
...
func (e *StyleElement) IfAttrsMap(condition bool, attrs map[string]string) *StyleElement {
	if condition {
		e.AttrsMap(attrs)
	}
	return e
...
func (e *StyleElement) MediaRemove() *StyleElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *StyleElement) NonceRemove() *StyleElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *StyleElement) TypeRemove() *StyleElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	StyleAutocapitalizeOff StyleAutocapitalizeChoice = "off"
	// Do not automatically capitalize any text.
	StyleAutocapitalizeNone StyleAutocapitalizeChoice = "none"
	// Automatically capitalize the first character of each sentence.
	StyleAutocapitalizeSentences StyleAutocapitalizeChoice = "sentences"
	// Automatically capitalize the first character of each sentence.
	StyleAutocapitalizeOn StyleAutocapitalizeChoice = "on"
	// Automatically capitalize the first character of each word.
	StyleAutocapitalizeWords StyleAutocapitalizeChoice = "words"
	// Automatically capitalize all characters.
	StyleAutocapitalizeCharacters StyleAutocapitalizeChoice = "characters"
)
...
func (e *StyleElement) AutocapitalizeRemove() *StyleElement {
	if e.stringAttributes == nil {
		return e
	}
...
// label, and the sighted user on a small device will equally miss the context
// created by the preceding content.
func (e *StyleElement) AutofocusIfRemove() *StyleElement {
	if e.boolAttributes == nil {
		return e
	}
	e.boolAttributes.Del("autofocus")
...
const (
	...
	StyleContenteditableEmpty StyleContenteditableChoice = ""
	// The element is editable.
	StyleContenteditableTrue StyleContenteditableChoice = "true"
	// The element is not editable.
	StyleContenteditableFalse StyleContenteditableChoice = "false"
	// which indicates that the element's raw text is editable, but rich text
	// formatting is disabled.
	StyleContenteditablePlaintextOnly StyleContenteditableChoice = "plaintext-only"
)
...
func (e *StyleElement) ContenteditableRemove() *StyleElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	StyleDirAuto StyleDirChoice = "auto"
)
...
func (e *StyleElement) DirRemove() *StyleElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	StyleDraggableTrue StyleDraggableChoice = "true"
	// The element is not draggable.
	StyleDraggableFalse StyleDraggableChoice = "false"
	...
	StyleDraggableEmpty StyleDraggableChoice = ""
	// drag behavior is the default browser behavior: only text selections, images,
	// and links can be dragged. For other elements, the event ondragstart must be
	// set for drag and drop to work
	StyleDraggableAuto StyleDraggableChoice = "auto"
)
...
func (e *StyleElement) DraggableRemove() *StyleElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	StyleHiddenEmpty StyleHiddenChoice = ""
	// set the element to the hidden state. Additionally, invalid values set the
	// element to the hidden state.
	StyleHiddenHidden StyleHiddenChoice = "hidden"
	...
	//
	StyleHiddenUntilFound StyleHiddenChoice = "until-found"
)
...
func (e *StyleElement) HiddenRemove() *StyleElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *StyleElement) IDRemove() *StyleElement {
	if e.stringAttributes == nil {
		return e
	}
...
// focus. Hides the element and its content from assistive technologies by
// excluding them from the accessibility tree.
func (e *StyleElement) InertIfRemove() *StyleElement {
	if e.boolAttributes == nil {
		return e
	}
	e.boolAttributes.Del("inert")
...
const (
	...
	// control.
	StyleInputmodeNone StyleInputmodeChoice = "none"
	// Standard input keyboard for the user's current locale.
	StyleInputmodeEmpty StyleInputmodeChoice = ""
	// Standard input keyboard for the user's current locale.
	StyleInputmodeText StyleInputmodeChoice = "text"
	...
	// key (-).
	StyleInputmodeDecimal StyleInputmodeChoice = "decimal"
	// Numeric input keyboard, but only requires the digits 0–9. Devices may or
	// may not show a minus key.
	StyleInputmodeNumeric StyleInputmodeChoice = "numeric"
	...
	StyleInputmodeTel StyleInputmodeChoice = "tel"
	...
	// type="search"> instead.
	StyleInputmodeSearch StyleInputmodeChoice = "search"
	...
	StyleInputmodeEmail StyleInputmodeChoice = "email"
	...
	StyleInputmodeURL StyleInputmodeChoice = "url"
)
...
func (e *StyleElement) InputmodeRemove() *StyleElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *StyleElement) IsRemove() *StyleElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *StyleElement) ItemidRemove() *StyleElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *StyleElement) ItempropRemove() *StyleElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *StyleElement) ItemrefRemove() *StyleElement {
	if e.stringAttributes == nil {
		return e
	}
...
// range of elements including <audio>, <embed>, <iframe>, <img>, <link>,
// <object>, <source>, <track>, and <video>.
func (e *StyleElement) ItemscopeIfRemove() *StyleElement {
	if e.boolAttributes == nil {
		return e
	}
	e.boolAttributes.Del("itemscope")
...
func (e *StyleElement) ItemtypeRemove() *StyleElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *StyleElement) LangRemove() *StyleElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	StylePopoverAuto StylePopoverChoice = "auto"
	// Popovers that have the auto state can be "light dismissed" by selecting
	// outside the popover area, and generally only allow one popover to be
	// displayed on-screen at a time.
	StylePopoverEmpty StylePopoverChoice = ""
	// manual popovers must always be explicitly hidden, but allow for use cases
	// such as nested popovers in menus.
	StylePopoverManual StylePopoverChoice = "manual"
)
...
func (e *StyleElement) PopoverRemove() *StyleElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *StyleElement) RoleRemove() *StyleElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *StyleElement) SlotRemove() *StyleElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	StyleSpellcheckEmpty StyleSpellcheckChoice = ""
	// The element will be checked for spelling errors.
	StyleSpellcheckTrue StyleSpellcheckChoice = "true"
	// The element will not be checked for spelling errors.
	StyleSpellcheckFalse StyleSpellcheckChoice = "false"
)
...
func (e *StyleElement) SpellcheckRemove() *StyleElement {
	if e.stringAttributes == nil {
		return e
	}
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *StyleElement) IfStyle(condition bool, s string) *StyleElement {
	if condition {
		e.Style(s)
	}
	return e
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *StyleElement) StyleAdd(k string, v string) *StyleElement {
	if e.keyValueStrings == nil {
		e.keyValueStrings = treemap.New[string, *keyValueBuilder]()
	}
	_, ok := e.keyValueStrings.Get("style")
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *StyleElement) IfStyleAdd(condition bool, k string, v string) *StyleElement {
	if condition {
		e.StyleAdd(k, v)
	}
	return e
...
func (e *StyleElement) TabindexRemove() *StyleElement {
	if e.intAttributes == nil {
		return e
	}
...
func (e *StyleElement) TitleRemove() *StyleElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	StyleTranslateEmpty StyleTranslateChoice = ""
	// indicates that the element should be translated when the page is localized.
	StyleTranslateYes StyleTranslateChoice = "yes"
	// indicates that the element must not be translated when the page is localized.
	StyleTranslateNo StyleTranslateChoice = "no"
)
...
func (e *StyleElement) TranslateRemove() *StyleElement {
	if e.stringAttributes == nil {
		return e
	}
