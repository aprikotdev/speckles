...
// Package elements html main is generated from configuration file.
package elements
...
// Create a new MainElement element. This will create a new element
// with the tag "main" during rendering.
...
func (e *MainElement) BoolAttr(name string) *MainElement {
...
func (e *MainElement) BoolAttrRemove(name string) *MainElement {
	if e.boolAttributes == nil {
		return e
	}
...
func (e *MainElement) BoolAttrf(format string, args ...any) *MainElement {
	return e.BoolAttr(fmt.Sprintf(format, args...))
}

func (e *MainElement) IfBoolAttrf(condition bool, format string, args ...any) *MainElement {
	if condition {
...
func (e *MainElement) BoolAttrs(names ...string) *MainElement {
...
func (e *MainElement) IfBoolAttrs(condition bool, names ...string) *MainElement {
	if condition {
		e.BoolAttrs(names...)
	}
	return e
...
func (e *MainElement) Attr(name, value string) *MainElement {
...
func (e *MainElement) IfAttr(condition bool, name, value string) *MainElement {
	if condition {
		e.Attr(name, value)
	}
	return e
...
func (e *MainElement) Attrf(name, format string, args ...any) *MainElement {
	return e.Attr(name, fmt.Sprintf(format, args...))
}

func (e *MainElement) IfAttrf(condition bool, name, format string, args ...any) *MainElement {
	if condition {
...
func (e *MainElement) IfAttrs(condition bool, attrs ...string) *MainElement {
	if condition {
		e.Attrs(attrs...)
	}
	return e
...
func (e *MainElement) IfAttrsMap(condition bool, attrs map[string]string) *MainElement {
	if condition {
		e.AttrsMap(attrs)
	}
	return e
...
const (
	...
	MainAutocapitalizeOff MainAutocapitalizeChoice = "off"
	// Do not automatically capitalize any text.
	MainAutocapitalizeNone MainAutocapitalizeChoice = "none"
	// Automatically capitalize the first character of each sentence.
	MainAutocapitalizeSentences MainAutocapitalizeChoice = "sentences"
	// Automatically capitalize the first character of each sentence.
	MainAutocapitalizeOn MainAutocapitalizeChoice = "on"
	// Automatically capitalize the first character of each word.
	MainAutocapitalizeWords MainAutocapitalizeChoice = "words"
	// Automatically capitalize all characters.
	MainAutocapitalizeCharacters MainAutocapitalizeChoice = "characters"
)
...
func (e *MainElement) AutocapitalizeRemove() *MainElement {
	if e.stringAttributes == nil {
		return e
	}
...
// label, and the sighted user on a small device will equally miss the context
// created by the preceding content.
func (e *MainElement) AutofocusIfRemove() *MainElement {
	if e.boolAttributes == nil {
		return e
	}
	e.boolAttributes.Del("autofocus")
...
const (
	...
	MainContenteditableEmpty MainContenteditableChoice = ""
	// The element is editable.
	MainContenteditableTrue MainContenteditableChoice = "true"
	// The element is not editable.
	MainContenteditableFalse MainContenteditableChoice = "false"
	// which indicates that the element's raw text is editable, but rich text
	// formatting is disabled.
	MainContenteditablePlaintextOnly MainContenteditableChoice = "plaintext-only"
)
...
func (e *MainElement) ContenteditableRemove() *MainElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	MainDirAuto MainDirChoice = "auto"
)
...
func (e *MainElement) DirRemove() *MainElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	MainDraggableTrue MainDraggableChoice = "true"
	// The element is not draggable.
	MainDraggableFalse MainDraggableChoice = "false"
	...
	MainDraggableEmpty MainDraggableChoice = ""
	// drag behavior is the default browser behavior: only text selections, images,
	// and links can be dragged. For other elements, the event ondragstart must be
	// set for drag and drop to work
	MainDraggableAuto MainDraggableChoice = "auto"
)
...
func (e *MainElement) DraggableRemove() *MainElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	MainHiddenEmpty MainHiddenChoice = ""
	// set the element to the hidden state. Additionally, invalid values set the
	// element to the hidden state.
	MainHiddenHidden MainHiddenChoice = "hidden"
	...
	//
	MainHiddenUntilFound MainHiddenChoice = "until-found"
)
...
func (e *MainElement) HiddenRemove() *MainElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *MainElement) IDRemove() *MainElement {
	if e.stringAttributes == nil {
		return e
	}
...
// focus. Hides the element and its content from assistive technologies by
// excluding them from the accessibility tree.
func (e *MainElement) InertIfRemove() *MainElement {
	if e.boolAttributes == nil {
		return e
	}
	e.boolAttributes.Del("inert")
...
const (
	...
	// control.
	MainInputmodeNone MainInputmodeChoice = "none"
	// Standard input keyboard for the user's current locale.
	MainInputmodeEmpty MainInputmodeChoice = ""
	// Standard input keyboard for the user's current locale.
	MainInputmodeText MainInputmodeChoice = "text"
	...
	// key (-).
	MainInputmodeDecimal MainInputmodeChoice = "decimal"
	// Numeric input keyboard, but only requires the digits 0–9. Devices may or
	// may not show a minus key.
	MainInputmodeNumeric MainInputmodeChoice = "numeric"
	...
	MainInputmodeTel MainInputmodeChoice = "tel"
	...
	// type="search"> instead.
	MainInputmodeSearch MainInputmodeChoice = "search"
	...
	MainInputmodeEmail MainInputmodeChoice = "email"
	...
	MainInputmodeURL MainInputmodeChoice = "url"
)
...
func (e *MainElement) InputmodeRemove() *MainElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *MainElement) IsRemove() *MainElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *MainElement) ItemidRemove() *MainElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *MainElement) ItempropRemove() *MainElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *MainElement) ItemrefRemove() *MainElement {
	if e.stringAttributes == nil {
		return e
	}
...
// range of elements including <audio>, <embed>, <iframe>, <img>, <link>,
// <object>, <source>, <track>, and <video>.
func (e *MainElement) ItemscopeIfRemove() *MainElement {
	if e.boolAttributes == nil {
		return e
	}
	e.boolAttributes.Del("itemscope")
...
func (e *MainElement) ItemtypeRemove() *MainElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *MainElement) LangRemove() *MainElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *MainElement) NonceRemove() *MainElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	MainPopoverAuto MainPopoverChoice = "auto"
	// Popovers that have the auto state can be "light dismissed" by selecting
	// outside the popover area, and generally only allow one popover to be
	// displayed on-screen at a time.
	MainPopoverEmpty MainPopoverChoice = ""
	// manual popovers must always be explicitly hidden, but allow for use cases
	// such as nested popovers in menus.
	MainPopoverManual MainPopoverChoice = "manual"
)
...
func (e *MainElement) PopoverRemove() *MainElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *MainElement) RoleRemove() *MainElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *MainElement) SlotRemove() *MainElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	MainSpellcheckEmpty MainSpellcheckChoice = ""
	// The element will be checked for spelling errors.
	MainSpellcheckTrue MainSpellcheckChoice = "true"
	// The element will not be checked for spelling errors.
	MainSpellcheckFalse MainSpellcheckChoice = "false"
)
...
func (e *MainElement) SpellcheckRemove() *MainElement {
	if e.stringAttributes == nil {
		return e
	}
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *MainElement) IfStyle(condition bool, s string) *MainElement {
	if condition {
		e.Style(s)
	}
	return e
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *MainElement) StyleAdd(k string, v string) *MainElement {
	if e.keyValueStrings == nil {
		e.keyValueStrings = treemap.New[string, *keyValueBuilder]()
	}
	_, ok := e.keyValueStrings.Get("style")
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *MainElement) StyleAddf(k string, format string, args ...any) *MainElement {
	return e.StyleAdd(k, fmt.Sprintf(format, args...))
}

// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *MainElement) IfStyleAdd(condition bool, k string, v string) *MainElement {
	if condition {
		e.StyleAdd(k, v)
	}
	return e
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *MainElement) IfStyleAddf(condition bool, k string, format string, args ...any) *MainElement {
	if condition {
...
func (e *MainElement) TabindexRemove() *MainElement {
	if e.intAttributes == nil {
		return e
	}
...
func (e *MainElement) TitleRemove() *MainElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	MainTranslateEmpty MainTranslateChoice = ""
	// indicates that the element should be translated when the page is localized.
	MainTranslateYes MainTranslateChoice = "yes"
	// indicates that the element must not be translated when the page is localized.
	MainTranslateNo MainTranslateChoice = "no"
)
...
func (e *MainElement) TranslateRemove() *MainElement {
	if e.stringAttributes == nil {
		return e
	}
