...
// Package elements html q is generated from configuration file.
package elements
...
// Create a new QElement element. This will create a new element
// with the tag "q" during rendering.
...
func (e *QElement) BoolAttr(name string) *QElement {
...
func (e *QElement) BoolAttrRemove(name string) *QElement {
	if e.boolAttributes == nil {
		return e
	}
...
func (e *QElement) BoolAttrf(format string, args ...any) *QElement {
	return e.BoolAttr(fmt.Sprintf(format, args...))
}

func (e *QElement) IfBoolAttrf(condition bool, format string, args ...any) *QElement {
	if condition {
...
func (e *QElement) BoolAttrs(names ...string) *QElement {
...
func (e *QElement) IfBoolAttrs(condition bool, names ...string) *QElement {
	if condition {
		e.BoolAttrs(names...)
	}
	return e
...
func (e *QElement) Attr(name, value string) *QElement {
...
func (e *QElement) IfAttr(condition bool, name, value string) *QElement {
	if condition {
		e.Attr(name, value)
	}
	return e
...
func (e *QElement) Attrf(name, format string, args ...any) *QElement {
	return e.Attr(name, fmt.Sprintf(format, args...))
}

func (e *QElement) IfAttrf(condition bool, name, format string, args ...any) *QElement {
	if condition {
...
func (e *QElement) IfAttrs(condition bool, attrs ...string) *QElement {
	if condition {
		e.Attrs(attrs...)
	}
	return e
...
func (e *QElement) IfAttrsMap(condition bool, attrs map[string]string) *QElement {
	if condition {
		e.AttrsMap(attrs)
	}
	return e
...
func (e *QElement) CiteRemove() *QElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	QAutocapitalizeOff QAutocapitalizeChoice = "off"
	// Do not automatically capitalize any text.
	QAutocapitalizeNone QAutocapitalizeChoice = "none"
	// Automatically capitalize the first character of each sentence.
	QAutocapitalizeSentences QAutocapitalizeChoice = "sentences"
	// Automatically capitalize the first character of each sentence.
	QAutocapitalizeOn QAutocapitalizeChoice = "on"
	// Automatically capitalize the first character of each word.
	QAutocapitalizeWords QAutocapitalizeChoice = "words"
	// Automatically capitalize all characters.
	QAutocapitalizeCharacters QAutocapitalizeChoice = "characters"
)
...
func (e *QElement) AutocapitalizeRemove() *QElement {
	if e.stringAttributes == nil {
		return e
	}
...
// label, and the sighted user on a small device will equally miss the context
// created by the preceding content.
func (e *QElement) AutofocusIfRemove() *QElement {
	if e.boolAttributes == nil {
		return e
	}
	e.boolAttributes.Del("autofocus")
...
const (
	...
	QContenteditableEmpty QContenteditableChoice = ""
	// The element is editable.
	QContenteditableTrue QContenteditableChoice = "true"
	// The element is not editable.
	QContenteditableFalse QContenteditableChoice = "false"
	// which indicates that the element's raw text is editable, but rich text
	// formatting is disabled.
	QContenteditablePlaintextOnly QContenteditableChoice = "plaintext-only"
)
...
func (e *QElement) ContenteditableRemove() *QElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *QElement) DirRemove() *QElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	QDraggableTrue QDraggableChoice = "true"
	// The element is not draggable.
	QDraggableFalse QDraggableChoice = "false"
	...
	QDraggableEmpty QDraggableChoice = ""
	// drag behavior is the default browser behavior: only text selections, images,
	// and links can be dragged. For other elements, the event ondragstart must be
	// set for drag and drop to work
	QDraggableAuto QDraggableChoice = "auto"
)
...
func (e *QElement) DraggableRemove() *QElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	QHiddenEmpty QHiddenChoice = ""
	// set the element to the hidden state. Additionally, invalid values set the
	// element to the hidden state.
	QHiddenHidden QHiddenChoice = "hidden"
	...
	//
	QHiddenUntilFound QHiddenChoice = "until-found"
)
...
func (e *QElement) HiddenRemove() *QElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *QElement) IDRemove() *QElement {
	if e.stringAttributes == nil {
		return e
	}
...
// focus. Hides the element and its content from assistive technologies by
// excluding them from the accessibility tree.
func (e *QElement) InertIfRemove() *QElement {
	if e.boolAttributes == nil {
		return e
	}
	e.boolAttributes.Del("inert")
...
const (
	...
	// control.
	QInputmodeNone QInputmodeChoice = "none"
	// Standard input keyboard for the user's current locale.
	QInputmodeEmpty QInputmodeChoice = ""
	// Standard input keyboard for the user's current locale.
	QInputmodeText QInputmodeChoice = "text"
	...
	QInputmodeTel QInputmodeChoice = "tel"
	...
	// type="search"> instead.
	QInputmodeSearch QInputmodeChoice = "search"
	...
	QInputmodeEmail QInputmodeChoice = "email"
	...
	QInputmodeURL QInputmodeChoice = "url"
)
...
func (e *QElement) InputmodeRemove() *QElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *QElement) IsRemove() *QElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *QElement) ItemidRemove() *QElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *QElement) ItempropRemove() *QElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *QElement) ItemrefRemove() *QElement {
	if e.stringAttributes == nil {
		return e
	}
...
// range of elements including <audio>, <embed>, <iframe>, <img>, <link>,
// <object>, <source>, <track>, and <video>.
func (e *QElement) ItemscopeIfRemove() *QElement {
	if e.boolAttributes == nil {
		return e
	}
	e.boolAttributes.Del("itemscope")
...
func (e *QElement) ItemtypeRemove() *QElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *QElement) LangRemove() *QElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *QElement) NonceRemove() *QElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *QElement) PopoverRemove() *QElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *QElement) RoleRemove() *QElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *QElement) SlotRemove() *QElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	QSpellcheckEmpty QSpellcheckChoice = ""
	// The element will be checked for spelling errors.
	QSpellcheckTrue QSpellcheckChoice = "true"
	// The element will not be checked for spelling errors.
	QSpellcheckFalse QSpellcheckChoice = "false"
)
...
func (e *QElement) SpellcheckRemove() *QElement {
	if e.stringAttributes == nil {
		return e
	}
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *QElement) IfStyle(condition bool, s string) *QElement {
	if condition {
		e.Style(s)
	}
	return e
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *QElement) StyleAdd(k string, v string) *QElement {
	if e.keyValueStrings == nil {
		e.keyValueStrings = treemap.New[string, *keyValueBuilder]()
	}
	_, ok := e.keyValueStrings.Get("style")
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *QElement) IfStyleAdd(condition bool, k string, v string) *QElement {
	if condition {
		e.StyleAdd(k, v)
	}
	return e
...
func (e *QElement) TabindexRemove() *QElement {
	if e.intAttributes == nil {
		return e
	}
...
func (e *QElement) TitleRemove() *QElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	QTranslateEmpty QTranslateChoice = ""
	// indicates that the element should be translated when the page is localized.
	QTranslateYes QTranslateChoice = "yes"
	// indicates that the element must not be translated when the page is localized.
	QTranslateNo QTranslateChoice = "no"
)
...
func (e *QElement) TranslateRemove() *QElement {
	if e.stringAttributes == nil {
		return e
	}
