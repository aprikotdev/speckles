...
// Package elements html summary is generated from configuration file.
package elements
...
// caption, or legend for a <details> element's disclosure box. Clicking the
// <summary> element toggles the state of the parent <details> element open and
// closed.
type SummaryElement struct {
	*Element
}

// Create a new SummaryElement element. This will create a new element
// with the tag "summary" during rendering.
...
func (e *SummaryElement) BoolAttr(name string) *SummaryElement {
...
func (e *SummaryElement) BoolAttrRemove(name string) *SummaryElement {
	if e.boolAttributes == nil {
		return e
	}
...
func (e *SummaryElement) BoolAttrf(format string, args ...any) *SummaryElement {
	return e.BoolAttr(fmt.Sprintf(format, args...))
}

func (e *SummaryElement) IfBoolAttrf(condition bool, format string, args ...any) *SummaryElement {
	if condition {
...
func (e *SummaryElement) BoolAttrs(names ...string) *SummaryElement {
...
func (e *SummaryElement) IfBoolAttrs(condition bool, names ...string) *SummaryElement {
	if condition {
		e.BoolAttrs(names...)
	}
	return e
...
func (e *SummaryElement) Attr(name, value string) *SummaryElement {
...
func (e *SummaryElement) IfAttr(condition bool, name, value string) *SummaryElement {
	if condition {
		e.Attr(name, value)
	}
	return e
...
func (e *SummaryElement) Attrf(name, format string, args ...any) *SummaryElement {
	return e.Attr(name, fmt.Sprintf(format, args...))
}

func (e *SummaryElement) IfAttrf(condition bool, name, format string, args ...any) *SummaryElement {
	if condition {
...
func (e *SummaryElement) IfAttrs(condition bool, attrs ...string) *SummaryElement {
	if condition {
		e.Attrs(attrs...)
	}
	return e
...
func (e *SummaryElement) IfAttrsMap(condition bool, attrs map[string]string) *SummaryElement {
	if condition {
		e.AttrsMap(attrs)
	}
	return e
...
const (
	...
	SummaryAutocapitalizeOff SummaryAutocapitalizeChoice = "off"
	// Do not automatically capitalize any text.
	SummaryAutocapitalizeNone SummaryAutocapitalizeChoice = "none"
	// Automatically capitalize the first character of each sentence.
	SummaryAutocapitalizeSentences SummaryAutocapitalizeChoice = "sentences"
	// Automatically capitalize the first character of each sentence.
	SummaryAutocapitalizeOn SummaryAutocapitalizeChoice = "on"
	// Automatically capitalize the first character of each word.
	SummaryAutocapitalizeWords SummaryAutocapitalizeChoice = "words"
	// Automatically capitalize all characters.
	SummaryAutocapitalizeCharacters SummaryAutocapitalizeChoice = "characters"
)
...
func (e *SummaryElement) AutocapitalizeRemove() *SummaryElement {
	if e.stringAttributes == nil {
		return e
	}
...
// label, and the sighted user on a small device will equally miss the context
// created by the preceding content.
func (e *SummaryElement) AutofocusRemove() *SummaryElement {
	if e.boolAttributes == nil {
		return e
	}
...
// label, and the sighted user on a small device will equally miss the context
// created by the preceding content.
func (e *SummaryElement) AutofocusIfRemove() *SummaryElement {
	if e.boolAttributes == nil {
		return e
	}
	e.boolAttributes.Del("autofocus")
...
const (
	...
	SummaryContenteditableEmpty SummaryContenteditableChoice = ""
	// The element is editable.
	SummaryContenteditableTrue SummaryContenteditableChoice = "true"
	// The element is not editable.
	SummaryContenteditableFalse SummaryContenteditableChoice = "false"
	// which indicates that the element's raw text is editable, but rich text
	// formatting is disabled.
	SummaryContenteditablePlaintextOnly SummaryContenteditableChoice = "plaintext-only"
)
...
func (e *SummaryElement) ContenteditableRemove() *SummaryElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	SummaryDirAuto SummaryDirChoice = "auto"
)
...
func (e *SummaryElement) DirRemove() *SummaryElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	SummaryDraggableTrue SummaryDraggableChoice = "true"
	// The element is not draggable.
	SummaryDraggableFalse SummaryDraggableChoice = "false"
	...
	SummaryDraggableEmpty SummaryDraggableChoice = ""
	// drag behavior is the default browser behavior: only text selections, images,
	// and links can be dragged. For other elements, the event ondragstart must be
	// set for drag and drop to work
	SummaryDraggableAuto SummaryDraggableChoice = "auto"
)
...
func (e *SummaryElement) DraggableRemove() *SummaryElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	SummaryEnterkeyhintEnter SummaryEnterkeyhintChoice = "enter"
	// Typically meaning there is nothing more to input and the input method editor
	// (IME) will be closed.
	SummaryEnterkeyhintDone SummaryEnterkeyhintChoice = "done"
	// Typically meaning to take the user to the target of the text they typed.
	SummaryEnterkeyhintGo SummaryEnterkeyhintChoice = "go"
	// Typically meaning to take the user to the next field that will accept text.
	SummaryEnterkeyhintNext SummaryEnterkeyhintChoice = "next"
	// Typically meaning to take the user to the previous field that will accept
	// text.
	SummaryEnterkeyhintPrevious SummaryEnterkeyhintChoice = "previous"
	// Typically taking the user to the results of searching for the text they have
	// typed.
	SummaryEnterkeyhintSearch SummaryEnterkeyhintChoice = "search"
	// Typically delivering the text to its target.
	SummaryEnterkeyhintSend SummaryEnterkeyhintChoice = "send"
)

// The enterkeyhint global Attribute is an enumerated attribute defining what
// action label (or icon) to present for the enter key on virtual keyboards.
// Remove the attribute Enterkeyhint from the element.
func (e *SummaryElement) EnterkeyhintRemove() *SummaryElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	SummaryHiddenEmpty SummaryHiddenChoice = ""
	// set the element to the hidden state. Additionally, invalid values set the
	// element to the hidden state.
	SummaryHiddenHidden SummaryHiddenChoice = "hidden"
	...
	//
	SummaryHiddenUntilFound SummaryHiddenChoice = "until-found"
)
...
func (e *SummaryElement) HiddenRemove() *SummaryElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *SummaryElement) IDRemove() *SummaryElement {
	if e.stringAttributes == nil {
		return e
	}
...
// focus. Hides the element and its content from assistive technologies by
// excluding them from the accessibility tree.
func (e *SummaryElement) InertRemove() *SummaryElement {
	if e.boolAttributes == nil {
		return e
	}
...
// focus. Hides the element and its content from assistive technologies by
// excluding them from the accessibility tree.
func (e *SummaryElement) InertIfRemove() *SummaryElement {
	if e.boolAttributes == nil {
		return e
	}
	e.boolAttributes.Del("inert")
...
const (
	...
	// control.
	SummaryInputmodeNone SummaryInputmodeChoice = "none"
	// Standard input keyboard for the user's current locale.
	SummaryInputmodeEmpty SummaryInputmodeChoice = ""
	// Standard input keyboard for the user's current locale.
	SummaryInputmodeText SummaryInputmodeChoice = "text"
	...
	// key (-).
	SummaryInputmodeDecimal SummaryInputmodeChoice = "decimal"
	// Numeric input keyboard, but only requires the digits 0–9. Devices may or
	// may not show a minus key.
	SummaryInputmodeNumeric SummaryInputmodeChoice = "numeric"
	...
	SummaryInputmodeTel SummaryInputmodeChoice = "tel"
	...
	// type="search"> instead.
	SummaryInputmodeSearch SummaryInputmodeChoice = "search"
	...
	SummaryInputmodeEmail SummaryInputmodeChoice = "email"
	...
	SummaryInputmodeURL SummaryInputmodeChoice = "url"
)
...
func (e *SummaryElement) InputmodeRemove() *SummaryElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *SummaryElement) IsRemove() *SummaryElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *SummaryElement) ItemidRemove() *SummaryElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *SummaryElement) ItempropRemove() *SummaryElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *SummaryElement) ItemrefRemove() *SummaryElement {
	if e.stringAttributes == nil {
		return e
	}
...
// range of elements including <audio>, <embed>, <iframe>, <img>, <link>,
// <object>, <source>, <track>, and <video>.
func (e *SummaryElement) ItemscopeRemove() *SummaryElement {
	if e.boolAttributes == nil {
		return e
	}
...
// range of elements including <audio>, <embed>, <iframe>, <img>, <link>,
// <object>, <source>, <track>, and <video>.
func (e *SummaryElement) ItemscopeIfRemove() *SummaryElement {
	if e.boolAttributes == nil {
		return e
	}
	e.boolAttributes.Del("itemscope")
...
func (e *SummaryElement) ItemtypeRemove() *SummaryElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *SummaryElement) LangRemove() *SummaryElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *SummaryElement) NonceRemove() *SummaryElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	SummaryPopoverAuto SummaryPopoverChoice = "auto"
	// Popovers that have the auto state can be "light dismissed" by selecting
	// outside the popover area, and generally only allow one popover to be
	// displayed on-screen at a time.
	SummaryPopoverEmpty SummaryPopoverChoice = ""
	// manual popovers must always be explicitly hidden, but allow for use cases
	// such as nested popovers in menus.
	SummaryPopoverManual SummaryPopoverChoice = "manual"
)
...
func (e *SummaryElement) PopoverRemove() *SummaryElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *SummaryElement) RoleRemove() *SummaryElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *SummaryElement) SlotRemove() *SummaryElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	SummarySpellcheckEmpty SummarySpellcheckChoice = ""
	// The element will be checked for spelling errors.
	SummarySpellcheckTrue SummarySpellcheckChoice = "true"
	// The element will not be checked for spelling errors.
	SummarySpellcheckFalse SummarySpellcheckChoice = "false"
)
...
func (e *SummaryElement) SpellcheckRemove() *SummaryElement {
	if e.stringAttributes == nil {
		return e
	}
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *SummaryElement) IfStyle(condition bool, s string) *SummaryElement {
	if condition {
		e.Style(s)
	}
	return e
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *SummaryElement) StyleAdd(k string, v string) *SummaryElement {
	if e.keyValueStrings == nil {
		e.keyValueStrings = treemap.New[string, *keyValueBuilder]()
	}
	_, ok := e.keyValueStrings.Get("style")
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *SummaryElement) StyleAddf(k string, format string, args ...any) *SummaryElement {
	return e.StyleAdd(k, fmt.Sprintf(format, args...))
}

// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *SummaryElement) IfStyleAdd(condition bool, k string, v string) *SummaryElement {
	if condition {
		e.StyleAdd(k, v)
	}
	return e
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *SummaryElement) IfStyleAddf(condition bool, k string, format string, args ...any) *SummaryElement {
	if condition {
...
func (e *SummaryElement) TabindexRemove() *SummaryElement {
	if e.intAttributes == nil {
		return e
	}
...
func (e *SummaryElement) TitleRemove() *SummaryElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	SummaryTranslateEmpty SummaryTranslateChoice = ""
	// indicates that the element should be translated when the page is localized.
	SummaryTranslateYes SummaryTranslateChoice = "yes"
	// indicates that the element must not be translated when the page is localized.
	SummaryTranslateNo SummaryTranslateChoice = "no"
)
...
func (e *SummaryElement) TranslateRemove() *SummaryElement {
	if e.stringAttributes == nil {
		return e
	}
