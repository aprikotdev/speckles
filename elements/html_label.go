...
// Package elements html label is generated from configuration file.
package elements
...
// Create a new LabelElement element. This will create a new element
// with the tag "label" during rendering.
...
func (e *LabelElement) BoolAttr(name string) *LabelElement {
...
func (e *LabelElement) BoolAttrRemove(name string) *LabelElement {
	if e.boolAttributes == nil {
		return e
	}
...
func (e *LabelElement) BoolAttrf(format string, args ...any) *LabelElement {
	return e.BoolAttr(fmt.Sprintf(format, args...))
}

func (e *LabelElement) IfBoolAttrf(condition bool, format string, args ...any) *LabelElement {
	if condition {
...
func (e *LabelElement) BoolAttrs(names ...string) *LabelElement {
...
func (e *LabelElement) IfBoolAttrs(condition bool, names ...string) *LabelElement {
	if condition {
		e.BoolAttrs(names...)
	}
	return e
...
func (e *LabelElement) Attr(name, value string) *LabelElement {
...
func (e *LabelElement) IfAttr(condition bool, name, value string) *LabelElement {
	if condition {
		e.Attr(name, value)
	}
	return e
...
func (e *LabelElement) Attrf(name, format string, args ...any) *LabelElement {
	return e.Attr(name, fmt.Sprintf(format, args...))
}

func (e *LabelElement) IfAttrf(condition bool, name, format string, args ...any) *LabelElement {
	if condition {
...
func (e *LabelElement) IfAttrs(condition bool, attrs ...string) *LabelElement {
	if condition {
		e.Attrs(attrs...)
	}
	return e
...
func (e *LabelElement) IfAttrsMap(condition bool, attrs map[string]string) *LabelElement {
	if condition {
		e.AttrsMap(attrs)
	}
	return e
...
func (e *LabelElement) ForRemove() *LabelElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *LabelElement) FormRemove() *LabelElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	LabelAutocapitalizeOff LabelAutocapitalizeChoice = "off"
	// Do not automatically capitalize any text.
	LabelAutocapitalizeNone LabelAutocapitalizeChoice = "none"
	// Automatically capitalize the first character of each sentence.
	LabelAutocapitalizeSentences LabelAutocapitalizeChoice = "sentences"
	// Automatically capitalize the first character of each sentence.
	LabelAutocapitalizeOn LabelAutocapitalizeChoice = "on"
	// Automatically capitalize the first character of each word.
	LabelAutocapitalizeWords LabelAutocapitalizeChoice = "words"
	// Automatically capitalize all characters.
	LabelAutocapitalizeCharacters LabelAutocapitalizeChoice = "characters"
)
...
func (e *LabelElement) AutocapitalizeRemove() *LabelElement {
	if e.stringAttributes == nil {
		return e
	}
...
// label, and the sighted user on a small device will equally miss the context
// created by the preceding content.
func (e *LabelElement) AutofocusRemove() *LabelElement {
	if e.boolAttributes == nil {
		return e
	}
...
// label, and the sighted user on a small device will equally miss the context
// created by the preceding content.
func (e *LabelElement) AutofocusIfRemove() *LabelElement {
	if e.boolAttributes == nil {
		return e
	}
	e.boolAttributes.Del("autofocus")
...
const (
	...
	LabelContenteditableEmpty LabelContenteditableChoice = ""
	// The element is editable.
	LabelContenteditableTrue LabelContenteditableChoice = "true"
	// The element is not editable.
	LabelContenteditableFalse LabelContenteditableChoice = "false"
	// which indicates that the element's raw text is editable, but rich text
	// formatting is disabled.
	LabelContenteditablePlaintextOnly LabelContenteditableChoice = "plaintext-only"
)
...
func (e *LabelElement) ContenteditableRemove() *LabelElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	LabelDirAuto LabelDirChoice = "auto"
)
...
func (e *LabelElement) DirRemove() *LabelElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	LabelDraggableTrue LabelDraggableChoice = "true"
	// The element is not draggable.
	LabelDraggableFalse LabelDraggableChoice = "false"
	...
	LabelDraggableEmpty LabelDraggableChoice = ""
	// drag behavior is the default browser behavior: only text selections, images,
	// and links can be dragged. For other elements, the event ondragstart must be
	// set for drag and drop to work
	LabelDraggableAuto LabelDraggableChoice = "auto"
)
...
func (e *LabelElement) DraggableRemove() *LabelElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	LabelHiddenEmpty LabelHiddenChoice = ""
	// set the element to the hidden state. Additionally, invalid values set the
	// element to the hidden state.
	LabelHiddenHidden LabelHiddenChoice = "hidden"
	...
	//
	LabelHiddenUntilFound LabelHiddenChoice = "until-found"
)
...
func (e *LabelElement) HiddenRemove() *LabelElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *LabelElement) IDRemove() *LabelElement {
	if e.stringAttributes == nil {
		return e
	}
...
// focus. Hides the element and its content from assistive technologies by
// excluding them from the accessibility tree.
func (e *LabelElement) InertRemove() *LabelElement {
	if e.boolAttributes == nil {
		return e
	}
...
// focus. Hides the element and its content from assistive technologies by
// excluding them from the accessibility tree.
func (e *LabelElement) InertIfRemove() *LabelElement {
	if e.boolAttributes == nil {
		return e
	}
	e.boolAttributes.Del("inert")
...
const (
	...
	// control.
	LabelInputmodeNone LabelInputmodeChoice = "none"
	// Standard input keyboard for the user's current locale.
	LabelInputmodeEmpty LabelInputmodeChoice = ""
	// Standard input keyboard for the user's current locale.
	LabelInputmodeText LabelInputmodeChoice = "text"
	...
	// key (-).
	LabelInputmodeDecimal LabelInputmodeChoice = "decimal"
	// Numeric input keyboard, but only requires the digits 0–9. Devices may or
	// may not show a minus key.
	LabelInputmodeNumeric LabelInputmodeChoice = "numeric"
	...
	LabelInputmodeTel LabelInputmodeChoice = "tel"
	...
	// type="search"> instead.
	LabelInputmodeSearch LabelInputmodeChoice = "search"
	...
	LabelInputmodeEmail LabelInputmodeChoice = "email"
	...
	LabelInputmodeURL LabelInputmodeChoice = "url"
)
...
func (e *LabelElement) InputmodeRemove() *LabelElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *LabelElement) IsRemove() *LabelElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *LabelElement) ItemidRemove() *LabelElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *LabelElement) ItempropRemove() *LabelElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *LabelElement) ItemrefRemove() *LabelElement {
	if e.stringAttributes == nil {
		return e
	}
...
// range of elements including <audio>, <embed>, <iframe>, <img>, <link>,
// <object>, <source>, <track>, and <video>.
func (e *LabelElement) ItemscopeRemove() *LabelElement {
	if e.boolAttributes == nil {
		return e
	}
...
// range of elements including <audio>, <embed>, <iframe>, <img>, <link>,
// <object>, <source>, <track>, and <video>.
func (e *LabelElement) ItemscopeIfRemove() *LabelElement {
	if e.boolAttributes == nil {
		return e
	}
	e.boolAttributes.Del("itemscope")
...
func (e *LabelElement) ItemtypeRemove() *LabelElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *LabelElement) LangRemove() *LabelElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *LabelElement) NonceRemove() *LabelElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	LabelPopoverAuto LabelPopoverChoice = "auto"
	// Popovers that have the auto state can be "light dismissed" by selecting
	// outside the popover area, and generally only allow one popover to be
	// displayed on-screen at a time.
	LabelPopoverEmpty LabelPopoverChoice = ""
	// manual popovers must always be explicitly hidden, but allow for use cases
	// such as nested popovers in menus.
	LabelPopoverManual LabelPopoverChoice = "manual"
)
...
func (e *LabelElement) PopoverRemove() *LabelElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *LabelElement) RoleRemove() *LabelElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *LabelElement) SlotRemove() *LabelElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	LabelSpellcheckEmpty LabelSpellcheckChoice = ""
	// The element will be checked for spelling errors.
	LabelSpellcheckTrue LabelSpellcheckChoice = "true"
	// The element will not be checked for spelling errors.
	LabelSpellcheckFalse LabelSpellcheckChoice = "false"
)
...
func (e *LabelElement) SpellcheckRemove() *LabelElement {
	if e.stringAttributes == nil {
		return e
	}
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *LabelElement) IfStyle(condition bool, s string) *LabelElement {
	if condition {
		e.Style(s)
	}
	return e
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *LabelElement) StyleAdd(k string, v string) *LabelElement {
	if e.keyValueStrings == nil {
		e.keyValueStrings = treemap.New[string, *keyValueBuilder]()
	}
	_, ok := e.keyValueStrings.Get("style")
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *LabelElement) IfStyleAdd(condition bool, k string, v string) *LabelElement {
	if condition {
		e.StyleAdd(k, v)
	}
	return e
...
func (e *LabelElement) TabindexRemove() *LabelElement {
	if e.intAttributes == nil {
		return e
	}
...
func (e *LabelElement) TitleRemove() *LabelElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	LabelTranslateEmpty LabelTranslateChoice = ""
	// indicates that the element should be translated when the page is localized.
	LabelTranslateYes LabelTranslateChoice = "yes"
	// indicates that the element must not be translated when the page is localized.
	LabelTranslateNo LabelTranslateChoice = "no"
)
...
func (e *LabelElement) TranslateRemove() *LabelElement {
	if e.stringAttributes == nil {
		return e
	}
