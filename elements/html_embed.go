...
// Package elements html embed is generated from configuration file.
package elements
...
// Create a new EmbedElement element. This will create a new element
...
func (e *EmbedElement) BoolAttrRemove(name string) *EmbedElement {
	if e.boolAttributes == nil {
		return e
	}
...
func (e *EmbedElement) BoolAttrf(format string, args ...any) *EmbedElement {
	return e.BoolAttr(fmt.Sprintf(format, args...))
}

func (e *EmbedElement) IfBoolAttrf(condition bool, format string, args ...any) *EmbedElement {
	if condition {
...
func (e *EmbedElement) BoolAttrs(names ...string) *EmbedElement {
...
func (e *EmbedElement) IfBoolAttrs(condition bool, names ...string) *EmbedElement {
	if condition {
		e.BoolAttrs(names...)
	}
	return e
...
func (e *EmbedElement) IfAttr(condition bool, name, value string) *EmbedElement {
	if condition {
		e.Attr(name, value)
	}
	return e
...
func (e *EmbedElement) Attrf(name, format string, args ...any) *EmbedElement {
	return e.Attr(name, fmt.Sprintf(format, args...))
}

func (e *EmbedElement) IfAttrf(condition bool, name, format string, args ...any) *EmbedElement {
	if condition {
...
func (e *EmbedElement) IfAttrs(condition bool, attrs ...string) *EmbedElement {
	if condition {
		e.Attrs(attrs...)
	}
	return e
...
func (e *EmbedElement) IfAttrsMap(condition bool, attrs map[string]string) *EmbedElement {
	if condition {
		e.AttrsMap(attrs)
	}
	return e
...
const (
	...
	EmbedAutocapitalizeOff EmbedAutocapitalizeChoice = "off"
	// Do not automatically capitalize any text.
	EmbedAutocapitalizeNone EmbedAutocapitalizeChoice = "none"
	// Automatically capitalize the first character of each sentence.
	EmbedAutocapitalizeSentences EmbedAutocapitalizeChoice = "sentences"
	// Automatically capitalize the first character of each sentence.
	EmbedAutocapitalizeOn EmbedAutocapitalizeChoice = "on"
	// Automatically capitalize the first character of each word.
	EmbedAutocapitalizeWords EmbedAutocapitalizeChoice = "words"
	// Automatically capitalize all characters.
	EmbedAutocapitalizeCharacters EmbedAutocapitalizeChoice = "characters"
)
...
// label, and the sighted user on a small device will equally miss the context
// created by the preceding content.
func (e *EmbedElement) AutofocusIfRemove() *EmbedElement {
	if e.boolAttributes == nil {
		return e
	}
	e.boolAttributes.Del("autofocus")
...
const (
	...
	EmbedContenteditableEmpty EmbedContenteditableChoice = ""
	// The element is editable.
	EmbedContenteditableTrue EmbedContenteditableChoice = "true"
	// The element is not editable.
	EmbedContenteditableFalse EmbedContenteditableChoice = "false"
	// which indicates that the element's raw text is editable, but rich text
	// formatting is disabled.
	EmbedContenteditablePlaintextOnly EmbedContenteditableChoice = "plaintext-only"
)
...
const (
	...
	EmbedDirAuto EmbedDirChoice = "auto"
)
...
const (
	...
	EmbedDraggableTrue EmbedDraggableChoice = "true"
	// The element is not draggable.
	EmbedDraggableFalse EmbedDraggableChoice = "false"
	...
	EmbedDraggableEmpty EmbedDraggableChoice = ""
	// drag behavior is the default browser behavior: only text selections, images,
	// and links can be dragged. For other elements, the event ondragstart must be
	// set for drag and drop to work
	EmbedDraggableAuto EmbedDraggableChoice = "auto"
)
...
const (
	...
	EmbedHiddenEmpty EmbedHiddenChoice = ""
	// set the element to the hidden state. Additionally, invalid values set the
	// element to the hidden state.
	EmbedHiddenHidden EmbedHiddenChoice = "hidden"
	...
	//
	EmbedHiddenUntilFound EmbedHiddenChoice = "until-found"
)
...
// focus. Hides the element and its content from assistive technologies by
// excluding them from the accessibility tree.
func (e *EmbedElement) InertIfRemove() *EmbedElement {
	if e.boolAttributes == nil {
		return e
	}
	e.boolAttributes.Del("inert")
...
const (
	...
	// control.
	EmbedInputmodeNone EmbedInputmodeChoice = "none"
	// Standard input keyboard for the user's current locale.
	EmbedInputmodeEmpty EmbedInputmodeChoice = ""
	// Standard input keyboard for the user's current locale.
	EmbedInputmodeText EmbedInputmodeChoice = "text"
	...
	// key (-).
	EmbedInputmodeDecimal EmbedInputmodeChoice = "decimal"
	// Numeric input keyboard, but only requires the digits 0–9. Devices may or
	// may not show a minus key.
	EmbedInputmodeNumeric EmbedInputmodeChoice = "numeric"
	...
	EmbedInputmodeTel EmbedInputmodeChoice = "tel"
	...
	// type="search"> instead.
	EmbedInputmodeSearch EmbedInputmodeChoice = "search"
	...
	EmbedInputmodeEmail EmbedInputmodeChoice = "email"
	...
	EmbedInputmodeURL EmbedInputmodeChoice = "url"
)
...
// range of elements including <audio>, <embed>, <iframe>, <img>, <link>,
// <object>, <source>, <track>, and <video>.
func (e *EmbedElement) ItemscopeIfRemove() *EmbedElement {
	if e.boolAttributes == nil {
		return e
	}
	e.boolAttributes.Del("itemscope")
...
const (
	...
	EmbedPopoverAuto EmbedPopoverChoice = "auto"
	// Popovers that have the auto state can be "light dismissed" by selecting
	// outside the popover area, and generally only allow one popover to be
	// displayed on-screen at a time.
	EmbedPopoverEmpty EmbedPopoverChoice = ""
	// manual popovers must always be explicitly hidden, but allow for use cases
	// such as nested popovers in menus.
	EmbedPopoverManual EmbedPopoverChoice = "manual"
)
...
const (
	...
	EmbedSpellcheckEmpty EmbedSpellcheckChoice = ""
	// The element will be checked for spelling errors.
	EmbedSpellcheckTrue EmbedSpellcheckChoice = "true"
	// The element will not be checked for spelling errors.
	EmbedSpellcheckFalse EmbedSpellcheckChoice = "false"
)
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *EmbedElement) IfStyle(condition bool, s string) *EmbedElement {
	if condition {
		e.Style(s)
	}
	return e
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *EmbedElement) IfStyleAdd(condition bool, k string, v string) *EmbedElement {
	if condition {
		e.StyleAdd(k, v)
	}
	return e
...
const (
	...
	EmbedTranslateEmpty EmbedTranslateChoice = ""
	// indicates that the element should be translated when the page is localized.
	EmbedTranslateYes EmbedTranslateChoice = "yes"
	// indicates that the element must not be translated when the page is localized.
	EmbedTranslateNo EmbedTranslateChoice = "no"
)
