...
// Package elements html sup is generated from configuration file.
package elements
...
// Create a new SupElement element. This will create a new element
// with the tag "sup" during rendering.
...
func (e *SupElement) BoolAttr(name string) *SupElement {
...
func (e *SupElement) BoolAttrRemove(name string) *SupElement {
	if e.boolAttributes == nil {
		return e
	}
...
func (e *SupElement) BoolAttrf(format string, args ...any) *SupElement {
	return e.BoolAttr(fmt.Sprintf(format, args...))
}

func (e *SupElement) IfBoolAttrf(condition bool, format string, args ...any) *SupElement {
	if condition {
...
func (e *SupElement) BoolAttrs(names ...string) *SupElement {
...
func (e *SupElement) IfBoolAttrs(condition bool, names ...string) *SupElement {
	if condition {
		e.BoolAttrs(names...)
	}
	return e
...
func (e *SupElement) Attr(name, value string) *SupElement {
...
func (e *SupElement) IfAttr(condition bool, name, value string) *SupElement {
	if condition {
		e.Attr(name, value)
	}
	return e
...
func (e *SupElement) Attrf(name, format string, args ...any) *SupElement {
	return e.Attr(name, fmt.Sprintf(format, args...))
}

func (e *SupElement) IfAttrf(condition bool, name, format string, args ...any) *SupElement {
	if condition {
...
func (e *SupElement) IfAttrs(condition bool, attrs ...string) *SupElement {
	if condition {
		e.Attrs(attrs...)
	}
	return e
...
func (e *SupElement) IfAttrsMap(condition bool, attrs map[string]string) *SupElement {
	if condition {
		e.AttrsMap(attrs)
	}
	return e
...
const (
	...
	SupAutocapitalizeOff SupAutocapitalizeChoice = "off"
	// Do not automatically capitalize any text.
	SupAutocapitalizeNone SupAutocapitalizeChoice = "none"
	// Automatically capitalize the first character of each sentence.
	SupAutocapitalizeSentences SupAutocapitalizeChoice = "sentences"
	// Automatically capitalize the first character of each sentence.
	SupAutocapitalizeOn SupAutocapitalizeChoice = "on"
	// Automatically capitalize the first character of each word.
	SupAutocapitalizeWords SupAutocapitalizeChoice = "words"
	// Automatically capitalize all characters.
	SupAutocapitalizeCharacters SupAutocapitalizeChoice = "characters"
)
...
func (e *SupElement) AutocapitalizeRemove() *SupElement {
	if e.stringAttributes == nil {
		return e
	}
...
// label, and the sighted user on a small device will equally miss the context
// created by the preceding content.
func (e *SupElement) AutofocusRemove() *SupElement {
	if e.boolAttributes == nil {
		return e
	}
...
// label, and the sighted user on a small device will equally miss the context
// created by the preceding content.
func (e *SupElement) AutofocusIfRemove() *SupElement {
	if e.boolAttributes == nil {
		return e
	}
	e.boolAttributes.Del("autofocus")
...
const (
	...
	SupContenteditableEmpty SupContenteditableChoice = ""
	// The element is editable.
	SupContenteditableTrue SupContenteditableChoice = "true"
	// The element is not editable.
	SupContenteditableFalse SupContenteditableChoice = "false"
	// which indicates that the element's raw text is editable, but rich text
	// formatting is disabled.
	SupContenteditablePlaintextOnly SupContenteditableChoice = "plaintext-only"
)
...
func (e *SupElement) ContenteditableRemove() *SupElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *SupElement) DirRemove() *SupElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	SupDraggableTrue SupDraggableChoice = "true"
	// The element is not draggable.
	SupDraggableFalse SupDraggableChoice = "false"
	...
	SupDraggableEmpty SupDraggableChoice = ""
	// drag behavior is the default browser behavior: only text selections, images,
	// and links can be dragged. For other elements, the event ondragstart must be
	// set for drag and drop to work
	SupDraggableAuto SupDraggableChoice = "auto"
)
...
func (e *SupElement) DraggableRemove() *SupElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	SupHiddenEmpty SupHiddenChoice = ""
	// set the element to the hidden state. Additionally, invalid values set the
	// element to the hidden state.
	SupHiddenHidden SupHiddenChoice = "hidden"
	...
	//
	SupHiddenUntilFound SupHiddenChoice = "until-found"
)
...
func (e *SupElement) HiddenRemove() *SupElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *SupElement) IDRemove() *SupElement {
	if e.stringAttributes == nil {
		return e
	}
...
// focus. Hides the element and its content from assistive technologies by
// excluding them from the accessibility tree.
func (e *SupElement) InertRemove() *SupElement {
	if e.boolAttributes == nil {
		return e
	}
...
// focus. Hides the element and its content from assistive technologies by
// excluding them from the accessibility tree.
func (e *SupElement) InertIfRemove() *SupElement {
	if e.boolAttributes == nil {
		return e
	}
	e.boolAttributes.Del("inert")
...
const (
	...
	// control.
	SupInputmodeNone SupInputmodeChoice = "none"
	// Standard input keyboard for the user's current locale.
	SupInputmodeEmpty SupInputmodeChoice = ""
	// Standard input keyboard for the user's current locale.
	SupInputmodeText SupInputmodeChoice = "text"
	...
	SupInputmodeTel SupInputmodeChoice = "tel"
	...
	// type="search"> instead.
	SupInputmodeSearch SupInputmodeChoice = "search"
	...
	SupInputmodeEmail SupInputmodeChoice = "email"
	...
	SupInputmodeURL SupInputmodeChoice = "url"
)
...
func (e *SupElement) InputmodeRemove() *SupElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *SupElement) IsRemove() *SupElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *SupElement) ItemidRemove() *SupElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *SupElement) ItempropRemove() *SupElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *SupElement) ItemrefRemove() *SupElement {
	if e.stringAttributes == nil {
		return e
	}
...
// range of elements including <audio>, <embed>, <iframe>, <img>, <link>,
// <object>, <source>, <track>, and <video>.
func (e *SupElement) ItemscopeRemove() *SupElement {
	if e.boolAttributes == nil {
		return e
	}
...
// range of elements including <audio>, <embed>, <iframe>, <img>, <link>,
// <object>, <source>, <track>, and <video>.
func (e *SupElement) ItemscopeIfRemove() *SupElement {
	if e.boolAttributes == nil {
		return e
	}
	e.boolAttributes.Del("itemscope")
...
func (e *SupElement) ItemtypeRemove() *SupElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *SupElement) LangRemove() *SupElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *SupElement) NonceRemove() *SupElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	SupPopoverAuto SupPopoverChoice = "auto"
	// Popovers that have the auto state can be "light dismissed" by selecting
	// outside the popover area, and generally only allow one popover to be
	// displayed on-screen at a time.
	SupPopoverEmpty SupPopoverChoice = ""
	// manual popovers must always be explicitly hidden, but allow for use cases
	// such as nested popovers in menus.
	SupPopoverManual SupPopoverChoice = "manual"
)
...
func (e *SupElement) PopoverRemove() *SupElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *SupElement) RoleRemove() *SupElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *SupElement) SlotRemove() *SupElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	SupSpellcheckEmpty SupSpellcheckChoice = ""
	// The element will be checked for spelling errors.
	SupSpellcheckTrue SupSpellcheckChoice = "true"
	// The element will not be checked for spelling errors.
	SupSpellcheckFalse SupSpellcheckChoice = "false"
)
...
func (e *SupElement) SpellcheckRemove() *SupElement {
	if e.stringAttributes == nil {
		return e
	}
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *SupElement) Style(s string) *SupElement {
	if e.keyValueStrings == nil {
		e.keyValueStrings = treemap.New[string, *keyValueBuilder]()
	}
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *SupElement) IfStyle(condition bool, s string) *SupElement {
	if condition {
		e.Style(s)
	}
	return e
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *SupElement) StyleAdd(k string, v string) *SupElement {
	if e.keyValueStrings == nil {
		e.keyValueStrings = treemap.New[string, *keyValueBuilder]()
	}
	_, ok := e.keyValueStrings.Get("style")
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *SupElement) StyleAddf(k string, format string, args ...any) *SupElement {
	return e.StyleAdd(k, fmt.Sprintf(format, args...))
}

// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *SupElement) IfStyleAdd(condition bool, k string, v string) *SupElement {
	if condition {
		e.StyleAdd(k, v)
	}
	return e
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *SupElement) IfStyleAddf(condition bool, k string, format string, args ...any) *SupElement {
	if condition {
...
func (e *SupElement) TabindexRemove() *SupElement {
	if e.intAttributes == nil {
		return e
	}
...
func (e *SupElement) TitleRemove() *SupElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	SupTranslateEmpty SupTranslateChoice = ""
	// indicates that the element should be translated when the page is localized.
	SupTranslateYes SupTranslateChoice = "yes"
	// indicates that the element must not be translated when the page is localized.
	SupTranslateNo SupTranslateChoice = "no"
)
...
func (e *SupElement) TranslateRemove() *SupElement {
	if e.stringAttributes == nil {
		return e
	}
