...
// Package elements html tr is generated from configuration file.
package elements
...
// The HTML <tr> element defines a row of cells in a table. The row's cells can
// then be established using a mix of <td> (data cell) and <th> (header cell)
// elements.
type TrElement struct {
	*Element
}

// Create a new TrElement element. This will create a new element
// with the tag "tr" during rendering.
...
func (e *TrElement) BoolAttr(name string) *TrElement {
...
func (e *TrElement) BoolAttrRemove(name string) *TrElement {
	if e.boolAttributes == nil {
		return e
	}
...
func (e *TrElement) BoolAttrf(format string, args ...any) *TrElement {
	return e.BoolAttr(fmt.Sprintf(format, args...))
}

func (e *TrElement) IfBoolAttrf(condition bool, format string, args ...any) *TrElement {
	if condition {
...
func (e *TrElement) BoolAttrs(names ...string) *TrElement {
...
func (e *TrElement) IfBoolAttrs(condition bool, names ...string) *TrElement {
	if condition {
		e.BoolAttrs(names...)
	}
	return e
...
func (e *TrElement) Attr(name, value string) *TrElement {
...
func (e *TrElement) IfAttr(condition bool, name, value string) *TrElement {
	if condition {
		e.Attr(name, value)
	}
	return e
...
func (e *TrElement) Attrf(name, format string, args ...any) *TrElement {
	return e.Attr(name, fmt.Sprintf(format, args...))
}

func (e *TrElement) IfAttrf(condition bool, name, format string, args ...any) *TrElement {
	if condition {
...
func (e *TrElement) IfAttrs(condition bool, attrs ...string) *TrElement {
	if condition {
		e.Attrs(attrs...)
	}
	return e
...
func (e *TrElement) IfAttrsMap(condition bool, attrs map[string]string) *TrElement {
	if condition {
		e.AttrsMap(attrs)
	}
	return e
...
const (
	...
	TrAutocapitalizeOff TrAutocapitalizeChoice = "off"
	// Do not automatically capitalize any text.
	TrAutocapitalizeNone TrAutocapitalizeChoice = "none"
	// Automatically capitalize the first character of each sentence.
	TrAutocapitalizeSentences TrAutocapitalizeChoice = "sentences"
	// Automatically capitalize the first character of each sentence.
	TrAutocapitalizeOn TrAutocapitalizeChoice = "on"
	// Automatically capitalize the first character of each word.
	TrAutocapitalizeWords TrAutocapitalizeChoice = "words"
	// Automatically capitalize all characters.
	TrAutocapitalizeCharacters TrAutocapitalizeChoice = "characters"
)
...
func (e *TrElement) AutocapitalizeRemove() *TrElement {
	if e.stringAttributes == nil {
		return e
	}
...
// label, and the sighted user on a small device will equally miss the context
// created by the preceding content.
func (e *TrElement) AutofocusRemove() *TrElement {
	if e.boolAttributes == nil {
		return e
	}
...
// label, and the sighted user on a small device will equally miss the context
// created by the preceding content.
func (e *TrElement) AutofocusIfRemove() *TrElement {
	if e.boolAttributes == nil {
		return e
	}
	e.boolAttributes.Del("autofocus")
...
const (
	...
	TrContenteditableEmpty TrContenteditableChoice = ""
	// The element is editable.
	TrContenteditableTrue TrContenteditableChoice = "true"
	// The element is not editable.
	TrContenteditableFalse TrContenteditableChoice = "false"
	// which indicates that the element's raw text is editable, but rich text
	// formatting is disabled.
	TrContenteditablePlaintextOnly TrContenteditableChoice = "plaintext-only"
)
...
func (e *TrElement) ContenteditableRemove() *TrElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *TrElement) DirRemove() *TrElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	TrDraggableTrue TrDraggableChoice = "true"
	// The element is not draggable.
	TrDraggableFalse TrDraggableChoice = "false"
	...
	TrDraggableEmpty TrDraggableChoice = ""
	// drag behavior is the default browser behavior: only text selections, images,
	// and links can be dragged. For other elements, the event ondragstart must be
	// set for drag and drop to work
	TrDraggableAuto TrDraggableChoice = "auto"
)
...
func (e *TrElement) DraggableRemove() *TrElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	TrHiddenEmpty TrHiddenChoice = ""
	// set the element to the hidden state. Additionally, invalid values set the
	// element to the hidden state.
	TrHiddenHidden TrHiddenChoice = "hidden"
	...
	//
	TrHiddenUntilFound TrHiddenChoice = "until-found"
)
...
func (e *TrElement) HiddenRemove() *TrElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *TrElement) IDRemove() *TrElement {
	if e.stringAttributes == nil {
		return e
	}
...
// focus. Hides the element and its content from assistive technologies by
// excluding them from the accessibility tree.
func (e *TrElement) InertRemove() *TrElement {
	if e.boolAttributes == nil {
		return e
	}
...
// focus. Hides the element and its content from assistive technologies by
// excluding them from the accessibility tree.
func (e *TrElement) InertIfRemove() *TrElement {
	if e.boolAttributes == nil {
		return e
	}
	e.boolAttributes.Del("inert")
...
const (
	...
	// control.
	TrInputmodeNone TrInputmodeChoice = "none"
	// Standard input keyboard for the user's current locale.
	TrInputmodeEmpty TrInputmodeChoice = ""
	// Standard input keyboard for the user's current locale.
	TrInputmodeText TrInputmodeChoice = "text"
	...
	TrInputmodeTel TrInputmodeChoice = "tel"
	...
	// type="search"> instead.
	TrInputmodeSearch TrInputmodeChoice = "search"
	...
	TrInputmodeEmail TrInputmodeChoice = "email"
	...
	TrInputmodeURL TrInputmodeChoice = "url"
)
...
func (e *TrElement) InputmodeRemove() *TrElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *TrElement) IsRemove() *TrElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *TrElement) ItemidRemove() *TrElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *TrElement) ItempropRemove() *TrElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *TrElement) ItemrefRemove() *TrElement {
	if e.stringAttributes == nil {
		return e
	}
...
// range of elements including <audio>, <embed>, <iframe>, <img>, <link>,
// <object>, <source>, <track>, and <video>.
func (e *TrElement) ItemscopeRemove() *TrElement {
	if e.boolAttributes == nil {
		return e
	}
...
// range of elements including <audio>, <embed>, <iframe>, <img>, <link>,
// <object>, <source>, <track>, and <video>.
func (e *TrElement) ItemscopeIfRemove() *TrElement {
	if e.boolAttributes == nil {
		return e
	}
	e.boolAttributes.Del("itemscope")
...
func (e *TrElement) ItemtypeRemove() *TrElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *TrElement) LangRemove() *TrElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *TrElement) NonceRemove() *TrElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *TrElement) PopoverRemove() *TrElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *TrElement) RoleRemove() *TrElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *TrElement) SlotRemove() *TrElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	TrSpellcheckEmpty TrSpellcheckChoice = ""
	// The element will be checked for spelling errors.
	TrSpellcheckTrue TrSpellcheckChoice = "true"
	// The element will not be checked for spelling errors.
	TrSpellcheckFalse TrSpellcheckChoice = "false"
)
...
func (e *TrElement) SpellcheckRemove() *TrElement {
	if e.stringAttributes == nil {
		return e
	}
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *TrElement) IfStyle(condition bool, s string) *TrElement {
	if condition {
		e.Style(s)
	}
	return e
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *TrElement) StyleAdd(k string, v string) *TrElement {
	if e.keyValueStrings == nil {
		e.keyValueStrings = treemap.New[string, *keyValueBuilder]()
	}
	_, ok := e.keyValueStrings.Get("style")
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *TrElement) IfStyleAdd(condition bool, k string, v string) *TrElement {
	if condition {
		e.StyleAdd(k, v)
	}
	return e
...
func (e *TrElement) TabindexRemove() *TrElement {
	if e.intAttributes == nil {
		return e
	}
...
func (e *TrElement) TitleRemove() *TrElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	TrTranslateEmpty TrTranslateChoice = ""
	// indicates that the element should be translated when the page is localized.
	TrTranslateYes TrTranslateChoice = "yes"
	// indicates that the element must not be translated when the page is localized.
	TrTranslateNo TrTranslateChoice = "no"
)
...
func (e *TrElement) TranslateRemove() *TrElement {
	if e.stringAttributes == nil {
		return e
	}
