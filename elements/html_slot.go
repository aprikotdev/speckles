...
// Package elements html slot is generated from configuration file.
package elements
...
// Create a new SlotElement element. This will create a new element
// with the tag "slot" during rendering.
...
func (e *SlotElement) BoolAttrRemove(name string) *SlotElement {
	if e.boolAttributes == nil {
		return e
	}
...
func (e *SlotElement) BoolAttrf(format string, args ...any) *SlotElement {
	return e.BoolAttr(fmt.Sprintf(format, args...))
}

func (e *SlotElement) IfBoolAttrf(condition bool, format string, args ...any) *SlotElement {
	if condition {
...
func (e *SlotElement) BoolAttrs(names ...string) *SlotElement {
...
func (e *SlotElement) IfBoolAttrs(condition bool, names ...string) *SlotElement {
	if condition {
		e.BoolAttrs(names...)
	}
	return e
...
func (e *SlotElement) Attrf(name, format string, args ...any) *SlotElement {
	return e.Attr(name, fmt.Sprintf(format, args...))
}

func (e *SlotElement) IfAttrf(condition bool, name, format string, args ...any) *SlotElement {
	if condition {
...
func (e *SlotElement) IfAttrs(condition bool, attrs ...string) *SlotElement {
	if condition {
		e.Attrs(attrs...)
	}
	return e
...
func (e *SlotElement) IfAttrsMap(condition bool, attrs map[string]string) *SlotElement {
	if condition {
		e.AttrsMap(attrs)
	}
	return e
...
func (e *SlotElement) NameRemove() *SlotElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	SlotAutocapitalizeOff SlotAutocapitalizeChoice = "off"
	// Do not automatically capitalize any text.
	SlotAutocapitalizeNone SlotAutocapitalizeChoice = "none"
	// Automatically capitalize the first character of each sentence.
	SlotAutocapitalizeSentences SlotAutocapitalizeChoice = "sentences"
	// Automatically capitalize the first character of each sentence.
	SlotAutocapitalizeOn SlotAutocapitalizeChoice = "on"
	// Automatically capitalize the first character of each word.
	SlotAutocapitalizeWords SlotAutocapitalizeChoice = "words"
	// Automatically capitalize all characters.
	SlotAutocapitalizeCharacters SlotAutocapitalizeChoice = "characters"
)
...
func (e *SlotElement) AutocapitalizeRemove() *SlotElement {
	if e.stringAttributes == nil {
		return e
	}
...
// label, and the sighted user on a small device will equally miss the context
// created by the preceding content.
func (e *SlotElement) AutofocusRemove() *SlotElement {
	if e.boolAttributes == nil {
		return e
	}
...
// label, and the sighted user on a small device will equally miss the context
// created by the preceding content.
func (e *SlotElement) AutofocusIfRemove() *SlotElement {
	if e.boolAttributes == nil {
		return e
	}
	e.boolAttributes.Del("autofocus")
...
const (
	...
	SlotContenteditableEmpty SlotContenteditableChoice = ""
	// The element is editable.
	SlotContenteditableTrue SlotContenteditableChoice = "true"
	// The element is not editable.
	SlotContenteditableFalse SlotContenteditableChoice = "false"
	// which indicates that the element's raw text is editable, but rich text
	// formatting is disabled.
	SlotContenteditablePlaintextOnly SlotContenteditableChoice = "plaintext-only"
)
...
func (e *SlotElement) ContenteditableRemove() *SlotElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	SlotDirAuto SlotDirChoice = "auto"
)
...
func (e *SlotElement) DirRemove() *SlotElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	SlotDraggableTrue SlotDraggableChoice = "true"
	// The element is not draggable.
	SlotDraggableFalse SlotDraggableChoice = "false"
	...
	SlotDraggableEmpty SlotDraggableChoice = ""
	// drag behavior is the default browser behavior: only text selections, images,
	// and links can be dragged. For other elements, the event ondragstart must be
	// set for drag and drop to work
	SlotDraggableAuto SlotDraggableChoice = "auto"
)
...
func (e *SlotElement) DraggableRemove() *SlotElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	SlotHiddenEmpty SlotHiddenChoice = ""
	// set the element to the hidden state. Additionally, invalid values set the
	// element to the hidden state.
	SlotHiddenHidden SlotHiddenChoice = "hidden"
	...
	//
	SlotHiddenUntilFound SlotHiddenChoice = "until-found"
)
...
func (e *SlotElement) HiddenRemove() *SlotElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *SlotElement) IDRemove() *SlotElement {
	if e.stringAttributes == nil {
		return e
	}
...
// focus. Hides the element and its content from assistive technologies by
// excluding them from the accessibility tree.
func (e *SlotElement) InertRemove() *SlotElement {
	if e.boolAttributes == nil {
		return e
	}
...
// focus. Hides the element and its content from assistive technologies by
// excluding them from the accessibility tree.
func (e *SlotElement) InertIfRemove() *SlotElement {
	if e.boolAttributes == nil {
		return e
	}
	e.boolAttributes.Del("inert")
...
const (
	...
	// control.
	SlotInputmodeNone SlotInputmodeChoice = "none"
	// Standard input keyboard for the user's current locale.
	SlotInputmodeEmpty SlotInputmodeChoice = ""
	// Standard input keyboard for the user's current locale.
	SlotInputmodeText SlotInputmodeChoice = "text"
	...
	// key (-).
	SlotInputmodeDecimal SlotInputmodeChoice = "decimal"
	// Numeric input keyboard, but only requires the digits 0–9. Devices may or
	// may not show a minus key.
	SlotInputmodeNumeric SlotInputmodeChoice = "numeric"
	...
	SlotInputmodeTel SlotInputmodeChoice = "tel"
	...
	// type="search"> instead.
	SlotInputmodeSearch SlotInputmodeChoice = "search"
	...
	SlotInputmodeEmail SlotInputmodeChoice = "email"
	...
	SlotInputmodeURL SlotInputmodeChoice = "url"
)
...
func (e *SlotElement) InputmodeRemove() *SlotElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *SlotElement) IsRemove() *SlotElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *SlotElement) ItemidRemove() *SlotElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *SlotElement) ItempropRemove() *SlotElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *SlotElement) ItemrefRemove() *SlotElement {
	if e.stringAttributes == nil {
		return e
	}
...
// range of elements including <audio>, <embed>, <iframe>, <img>, <link>,
// <object>, <source>, <track>, and <video>.
func (e *SlotElement) ItemscopeRemove() *SlotElement {
	if e.boolAttributes == nil {
		return e
	}
...
// range of elements including <audio>, <embed>, <iframe>, <img>, <link>,
// <object>, <source>, <track>, and <video>.
func (e *SlotElement) ItemscopeIfRemove() *SlotElement {
	if e.boolAttributes == nil {
		return e
	}
	e.boolAttributes.Del("itemscope")
...
func (e *SlotElement) ItemtypeRemove() *SlotElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *SlotElement) LangRemove() *SlotElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *SlotElement) NonceRemove() *SlotElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	SlotPopoverAuto SlotPopoverChoice = "auto"
	// Popovers that have the auto state can be "light dismissed" by selecting
	// outside the popover area, and generally only allow one popover to be
	// displayed on-screen at a time.
	SlotPopoverEmpty SlotPopoverChoice = ""
	// manual popovers must always be explicitly hidden, but allow for use cases
	// such as nested popovers in menus.
	SlotPopoverManual SlotPopoverChoice = "manual"
)
...
func (e *SlotElement) PopoverRemove() *SlotElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *SlotElement) RoleRemove() *SlotElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *SlotElement) SlotRemove() *SlotElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	SlotSpellcheckEmpty SlotSpellcheckChoice = ""
	// The element will be checked for spelling errors.
	SlotSpellcheckTrue SlotSpellcheckChoice = "true"
	// The element will not be checked for spelling errors.
	SlotSpellcheckFalse SlotSpellcheckChoice = "false"
)
...
func (e *SlotElement) SpellcheckRemove() *SlotElement {
	if e.stringAttributes == nil {
		return e
	}
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *SlotElement) IfStyle(condition bool, s string) *SlotElement {
	if condition {
		e.Style(s)
	}
	return e
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *SlotElement) StyleAdd(k string, v string) *SlotElement {
	if e.keyValueStrings == nil {
		e.keyValueStrings = treemap.New[string, *keyValueBuilder]()
	}
	_, ok := e.keyValueStrings.Get("style")
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *SlotElement) IfStyleAdd(condition bool, k string, v string) *SlotElement {
	if condition {
		e.StyleAdd(k, v)
	}
	return e
...
func (e *SlotElement) TabindexRemove() *SlotElement {
	if e.intAttributes == nil {
		return e
	}
...
func (e *SlotElement) TitleRemove() *SlotElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	SlotTranslateEmpty SlotTranslateChoice = ""
	// indicates that the element should be translated when the page is localized.
	SlotTranslateYes SlotTranslateChoice = "yes"
	// indicates that the element must not be translated when the page is localized.
	SlotTranslateNo SlotTranslateChoice = "no"
)
...
func (e *SlotElement) TranslateRemove() *SlotElement {
	if e.stringAttributes == nil {
		return e
	}
