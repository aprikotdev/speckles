...
// Package elements html strong is generated from configuration file.
package elements
...
// Create a new StrongElement element. This will create a new element
// with the tag "strong" during rendering.
...
func (e *StrongElement) BoolAttr(name string) *StrongElement {
...
func (e *StrongElement) BoolAttrRemove(name string) *StrongElement {
	if e.boolAttributes == nil {
		return e
	}
...
func (e *StrongElement) BoolAttrf(format string, args ...any) *StrongElement {
	return e.BoolAttr(fmt.Sprintf(format, args...))
}

func (e *StrongElement) IfBoolAttrf(condition bool, format string, args ...any) *StrongElement {
	if condition {
...
func (e *StrongElement) BoolAttrs(names ...string) *StrongElement {
...
func (e *StrongElement) IfBoolAttrs(condition bool, names ...string) *StrongElement {
	if condition {
		e.BoolAttrs(names...)
	}
	return e
...
func (e *StrongElement) Attr(name, value string) *StrongElement {
...
func (e *StrongElement) IfAttr(condition bool, name, value string) *StrongElement {
	if condition {
		e.Attr(name, value)
	}
	return e
...
func (e *StrongElement) Attrf(name, format string, args ...any) *StrongElement {
	return e.Attr(name, fmt.Sprintf(format, args...))
}

func (e *StrongElement) IfAttrf(condition bool, name, format string, args ...any) *StrongElement {
	if condition {
...
func (e *StrongElement) IfAttrs(condition bool, attrs ...string) *StrongElement {
	if condition {
		e.Attrs(attrs...)
	}
	return e
...
func (e *StrongElement) IfAttrsMap(condition bool, attrs map[string]string) *StrongElement {
	if condition {
		e.AttrsMap(attrs)
	}
	return e
...
const (
	...
	StrongAutocapitalizeOff StrongAutocapitalizeChoice = "off"
	// Do not automatically capitalize any text.
	StrongAutocapitalizeNone StrongAutocapitalizeChoice = "none"
	// Automatically capitalize the first character of each sentence.
	StrongAutocapitalizeSentences StrongAutocapitalizeChoice = "sentences"
	// Automatically capitalize the first character of each sentence.
	StrongAutocapitalizeOn StrongAutocapitalizeChoice = "on"
	// Automatically capitalize the first character of each word.
	StrongAutocapitalizeWords StrongAutocapitalizeChoice = "words"
	// Automatically capitalize all characters.
	StrongAutocapitalizeCharacters StrongAutocapitalizeChoice = "characters"
)
...
func (e *StrongElement) AutocapitalizeRemove() *StrongElement {
	if e.stringAttributes == nil {
		return e
	}
...
// label, and the sighted user on a small device will equally miss the context
// created by the preceding content.
func (e *StrongElement) AutofocusRemove() *StrongElement {
	if e.boolAttributes == nil {
		return e
	}
...
// label, and the sighted user on a small device will equally miss the context
// created by the preceding content.
func (e *StrongElement) AutofocusIfRemove() *StrongElement {
	if e.boolAttributes == nil {
		return e
	}
	e.boolAttributes.Del("autofocus")
...
const (
	...
	StrongContenteditableEmpty StrongContenteditableChoice = ""
	// The element is editable.
	StrongContenteditableTrue StrongContenteditableChoice = "true"
	// The element is not editable.
	StrongContenteditableFalse StrongContenteditableChoice = "false"
	// which indicates that the element's raw text is editable, but rich text
	// formatting is disabled.
	StrongContenteditablePlaintextOnly StrongContenteditableChoice = "plaintext-only"
)
...
func (e *StrongElement) ContenteditableRemove() *StrongElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	StrongDirAuto StrongDirChoice = "auto"
)
...
func (e *StrongElement) DirRemove() *StrongElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	StrongDraggableTrue StrongDraggableChoice = "true"
	// The element is not draggable.
	StrongDraggableFalse StrongDraggableChoice = "false"
	...
	StrongDraggableEmpty StrongDraggableChoice = ""
	// drag behavior is the default browser behavior: only text selections, images,
	// and links can be dragged. For other elements, the event ondragstart must be
	// set for drag and drop to work
	StrongDraggableAuto StrongDraggableChoice = "auto"
)
...
func (e *StrongElement) DraggableRemove() *StrongElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	StrongEnterkeyhintEnter StrongEnterkeyhintChoice = "enter"
	// Typically meaning there is nothing more to input and the input method editor
	// (IME) will be closed.
	StrongEnterkeyhintDone StrongEnterkeyhintChoice = "done"
	// Typically meaning to take the user to the target of the text they typed.
	StrongEnterkeyhintGo StrongEnterkeyhintChoice = "go"
	// Typically meaning to take the user to the next field that will accept text.
	StrongEnterkeyhintNext StrongEnterkeyhintChoice = "next"
	// Typically meaning to take the user to the previous field that will accept
	// text.
	StrongEnterkeyhintPrevious StrongEnterkeyhintChoice = "previous"
	// Typically taking the user to the results of searching for the text they have
	// typed.
	StrongEnterkeyhintSearch StrongEnterkeyhintChoice = "search"
	// Typically delivering the text to its target.
	StrongEnterkeyhintSend StrongEnterkeyhintChoice = "send"
)

// The enterkeyhint global Attribute is an enumerated attribute defining what
// action label (or icon) to present for the enter key on virtual keyboards.
// Remove the attribute Enterkeyhint from the element.
func (e *StrongElement) EnterkeyhintRemove() *StrongElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	StrongHiddenEmpty StrongHiddenChoice = ""
	// set the element to the hidden state. Additionally, invalid values set the
	// element to the hidden state.
	StrongHiddenHidden StrongHiddenChoice = "hidden"
	...
	//
	StrongHiddenUntilFound StrongHiddenChoice = "until-found"
)
...
func (e *StrongElement) HiddenRemove() *StrongElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *StrongElement) IDRemove() *StrongElement {
	if e.stringAttributes == nil {
		return e
	}
...
// focus. Hides the element and its content from assistive technologies by
// excluding them from the accessibility tree.
func (e *StrongElement) InertRemove() *StrongElement {
	if e.boolAttributes == nil {
		return e
	}
...
// focus. Hides the element and its content from assistive technologies by
// excluding them from the accessibility tree.
func (e *StrongElement) InertIfRemove() *StrongElement {
	if e.boolAttributes == nil {
		return e
	}
	e.boolAttributes.Del("inert")
...
const (
	...
	// control.
	StrongInputmodeNone StrongInputmodeChoice = "none"
	// Standard input keyboard for the user's current locale.
	StrongInputmodeEmpty StrongInputmodeChoice = ""
	// Standard input keyboard for the user's current locale.
	StrongInputmodeText StrongInputmodeChoice = "text"
	...
	// key (-).
	StrongInputmodeDecimal StrongInputmodeChoice = "decimal"
	// Numeric input keyboard, but only requires the digits 0–9. Devices may or
	// may not show a minus key.
	StrongInputmodeNumeric StrongInputmodeChoice = "numeric"
	...
	StrongInputmodeTel StrongInputmodeChoice = "tel"
	...
	// type="search"> instead.
	StrongInputmodeSearch StrongInputmodeChoice = "search"
	...
	StrongInputmodeEmail StrongInputmodeChoice = "email"
	...
	StrongInputmodeURL StrongInputmodeChoice = "url"
)
...
func (e *StrongElement) InputmodeRemove() *StrongElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *StrongElement) IsRemove() *StrongElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *StrongElement) ItemidRemove() *StrongElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *StrongElement) ItempropRemove() *StrongElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *StrongElement) ItemrefRemove() *StrongElement {
	if e.stringAttributes == nil {
		return e
	}
...
// range of elements including <audio>, <embed>, <iframe>, <img>, <link>,
// <object>, <source>, <track>, and <video>.
func (e *StrongElement) ItemscopeRemove() *StrongElement {
	if e.boolAttributes == nil {
		return e
	}
...
// range of elements including <audio>, <embed>, <iframe>, <img>, <link>,
// <object>, <source>, <track>, and <video>.
func (e *StrongElement) ItemscopeIfRemove() *StrongElement {
	if e.boolAttributes == nil {
		return e
	}
	e.boolAttributes.Del("itemscope")
...
func (e *StrongElement) ItemtypeRemove() *StrongElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *StrongElement) LangRemove() *StrongElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *StrongElement) NonceRemove() *StrongElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	StrongPopoverAuto StrongPopoverChoice = "auto"
	// Popovers that have the auto state can be "light dismissed" by selecting
	// outside the popover area, and generally only allow one popover to be
	// displayed on-screen at a time.
	StrongPopoverEmpty StrongPopoverChoice = ""
	// manual popovers must always be explicitly hidden, but allow for use cases
	// such as nested popovers in menus.
	StrongPopoverManual StrongPopoverChoice = "manual"
)
...
func (e *StrongElement) PopoverRemove() *StrongElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *StrongElement) RoleRemove() *StrongElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *StrongElement) SlotRemove() *StrongElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	StrongSpellcheckEmpty StrongSpellcheckChoice = ""
	// The element will be checked for spelling errors.
	StrongSpellcheckTrue StrongSpellcheckChoice = "true"
	// The element will not be checked for spelling errors.
	StrongSpellcheckFalse StrongSpellcheckChoice = "false"
)
...
func (e *StrongElement) SpellcheckRemove() *StrongElement {
	if e.stringAttributes == nil {
		return e
	}
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *StrongElement) IfStyle(condition bool, s string) *StrongElement {
	if condition {
		e.Style(s)
	}
	return e
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *StrongElement) StyleAdd(k string, v string) *StrongElement {
	if e.keyValueStrings == nil {
		e.keyValueStrings = treemap.New[string, *keyValueBuilder]()
	}
	_, ok := e.keyValueStrings.Get("style")
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *StrongElement) IfStyleAdd(condition bool, k string, v string) *StrongElement {
	if condition {
		e.StyleAdd(k, v)
	}
	return e
...
func (e *StrongElement) TabindexRemove() *StrongElement {
	if e.intAttributes == nil {
		return e
	}
...
func (e *StrongElement) TitleRemove() *StrongElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	StrongTranslateEmpty StrongTranslateChoice = ""
	// indicates that the element should be translated when the page is localized.
	StrongTranslateYes StrongTranslateChoice = "yes"
	// indicates that the element must not be translated when the page is localized.
	StrongTranslateNo StrongTranslateChoice = "no"
)
...
func (e *StrongElement) TranslateRemove() *StrongElement {
	if e.stringAttributes == nil {
		return e
	}
