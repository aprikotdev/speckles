...
// Package elements html address is generated from configuration file.
package elements
...
// Create a new AddressElement element. This will create a new element
// with the tag "address" during rendering.
...
func (e *AddressElement) BoolAttr(name string) *AddressElement {
...
func (e *AddressElement) BoolAttrRemove(name string) *AddressElement {
	if e.boolAttributes == nil {
		return e
	}
...
func (e *AddressElement) BoolAttrf(format string, args ...any) *AddressElement {
	return e.BoolAttr(fmt.Sprintf(format, args...))
}

func (e *AddressElement) IfBoolAttrf(condition bool, format string, args ...any) *AddressElement {
	if condition {
...
func (e *AddressElement) BoolAttrs(names ...string) *AddressElement {
...
func (e *AddressElement) IfBoolAttrs(condition bool, names ...string) *AddressElement {
	if condition {
		e.BoolAttrs(names...)
	}
	return e
...
func (e *AddressElement) Attr(name, value string) *AddressElement {
...
func (e *AddressElement) IfAttr(condition bool, name, value string) *AddressElement {
	if condition {
		e.Attr(name, value)
	}
	return e
...
func (e *AddressElement) Attrf(name, format string, args ...any) *AddressElement {
	return e.Attr(name, fmt.Sprintf(format, args...))
}

func (e *AddressElement) IfAttrf(condition bool, name, format string, args ...any) *AddressElement {
	if condition {
...
func (e *AddressElement) IfAttrs(condition bool, attrs ...string) *AddressElement {
	if condition {
		e.Attrs(attrs...)
	}
	return e
...
func (e *AddressElement) IfAttrsMap(condition bool, attrs map[string]string) *AddressElement {
	if condition {
		e.AttrsMap(attrs)
	}
	return e
...
const (
	...
	AddressAutocapitalizeOff AddressAutocapitalizeChoice = "off"
	// Do not automatically capitalize any text.
	AddressAutocapitalizeNone AddressAutocapitalizeChoice = "none"
	// Automatically capitalize the first character of each sentence.
	AddressAutocapitalizeSentences AddressAutocapitalizeChoice = "sentences"
	// Automatically capitalize the first character of each sentence.
	AddressAutocapitalizeOn AddressAutocapitalizeChoice = "on"
	// Automatically capitalize the first character of each word.
	AddressAutocapitalizeWords AddressAutocapitalizeChoice = "words"
	// Automatically capitalize all characters.
	AddressAutocapitalizeCharacters AddressAutocapitalizeChoice = "characters"
)
...
func (e *AddressElement) AutocapitalizeRemove() *AddressElement {
	if e.stringAttributes == nil {
		return e
	}
...
// label, and the sighted user on a small device will equally miss the context
// created by the preceding content.
func (e *AddressElement) AutofocusRemove() *AddressElement {
	if e.boolAttributes == nil {
		return e
	}
...
// label, and the sighted user on a small device will equally miss the context
// created by the preceding content.
func (e *AddressElement) AutofocusIfRemove() *AddressElement {
	if e.boolAttributes == nil {
		return e
	}
	e.boolAttributes.Del("autofocus")
...
const (
	...
	AddressContenteditableEmpty AddressContenteditableChoice = ""
	// The element is editable.
	AddressContenteditableTrue AddressContenteditableChoice = "true"
	// The element is not editable.
	AddressContenteditableFalse AddressContenteditableChoice = "false"
	// which indicates that the element's raw text is editable, but rich text
	// formatting is disabled.
	AddressContenteditablePlaintextOnly AddressContenteditableChoice = "plaintext-only"
)
...
func (e *AddressElement) ContenteditableRemove() *AddressElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	AddressDirAuto AddressDirChoice = "auto"
)
...
func (e *AddressElement) DirRemove() *AddressElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	AddressDraggableTrue AddressDraggableChoice = "true"
	// The element is not draggable.
	AddressDraggableFalse AddressDraggableChoice = "false"
	...
	AddressDraggableEmpty AddressDraggableChoice = ""
	// drag behavior is the default browser behavior: only text selections, images,
	// and links can be dragged. For other elements, the event ondragstart must be
	// set for drag and drop to work
	AddressDraggableAuto AddressDraggableChoice = "auto"
)
...
func (e *AddressElement) DraggableRemove() *AddressElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	AddressEnterkeyhintEnter AddressEnterkeyhintChoice = "enter"
	// Typically meaning there is nothing more to input and the input method editor
	// (IME) will be closed.
	AddressEnterkeyhintDone AddressEnterkeyhintChoice = "done"
	// Typically meaning to take the user to the target of the text they typed.
	AddressEnterkeyhintGo AddressEnterkeyhintChoice = "go"
	// Typically meaning to take the user to the next field that will accept text.
	AddressEnterkeyhintNext AddressEnterkeyhintChoice = "next"
	// Typically meaning to take the user to the previous field that will accept
	// text.
	AddressEnterkeyhintPrevious AddressEnterkeyhintChoice = "previous"
	// Typically taking the user to the results of searching for the text they have
	// typed.
	AddressEnterkeyhintSearch AddressEnterkeyhintChoice = "search"
	// Typically delivering the text to its target.
	AddressEnterkeyhintSend AddressEnterkeyhintChoice = "send"
)

// The enterkeyhint global Attribute is an enumerated attribute defining what
// action label (or icon) to present for the enter key on virtual keyboards.
// Remove the attribute Enterkeyhint from the element.
func (e *AddressElement) EnterkeyhintRemove() *AddressElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	AddressHiddenEmpty AddressHiddenChoice = ""
	// set the element to the hidden state. Additionally, invalid values set the
	// element to the hidden state.
	AddressHiddenHidden AddressHiddenChoice = "hidden"
	...
	//
	AddressHiddenUntilFound AddressHiddenChoice = "until-found"
)
...
func (e *AddressElement) HiddenRemove() *AddressElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *AddressElement) IDRemove() *AddressElement {
	if e.stringAttributes == nil {
		return e
	}
...
// focus. Hides the element and its content from assistive technologies by
// excluding them from the accessibility tree.
func (e *AddressElement) InertRemove() *AddressElement {
	if e.boolAttributes == nil {
		return e
	}
...
// focus. Hides the element and its content from assistive technologies by
// excluding them from the accessibility tree.
func (e *AddressElement) InertIfRemove() *AddressElement {
	if e.boolAttributes == nil {
		return e
	}
	e.boolAttributes.Del("inert")
...
const (
	...
	// control.
	AddressInputmodeNone AddressInputmodeChoice = "none"
	// Standard input keyboard for the user's current locale.
	AddressInputmodeEmpty AddressInputmodeChoice = ""
	// Standard input keyboard for the user's current locale.
	AddressInputmodeText AddressInputmodeChoice = "text"
	...
	// key (-).
	AddressInputmodeDecimal AddressInputmodeChoice = "decimal"
	// Numeric input keyboard, but only requires the digits 0–9. Devices may or
	// may not show a minus key.
	AddressInputmodeNumeric AddressInputmodeChoice = "numeric"
	...
	AddressInputmodeTel AddressInputmodeChoice = "tel"
	...
	// type="search"> instead.
	AddressInputmodeSearch AddressInputmodeChoice = "search"
	...
	AddressInputmodeEmail AddressInputmodeChoice = "email"
	...
	AddressInputmodeURL AddressInputmodeChoice = "url"
)
...
func (e *AddressElement) InputmodeRemove() *AddressElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *AddressElement) IsRemove() *AddressElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *AddressElement) ItemidRemove() *AddressElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *AddressElement) ItempropRemove() *AddressElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *AddressElement) ItemrefRemove() *AddressElement {
	if e.stringAttributes == nil {
		return e
	}
...
// range of elements including <audio>, <embed>, <iframe>, <img>, <link>,
// <object>, <source>, <track>, and <video>.
func (e *AddressElement) ItemscopeRemove() *AddressElement {
	if e.boolAttributes == nil {
		return e
	}
...
// range of elements including <audio>, <embed>, <iframe>, <img>, <link>,
// <object>, <source>, <track>, and <video>.
func (e *AddressElement) ItemscopeIfRemove() *AddressElement {
	if e.boolAttributes == nil {
		return e
	}
	e.boolAttributes.Del("itemscope")
...
func (e *AddressElement) ItemtypeRemove() *AddressElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *AddressElement) LangRemove() *AddressElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *AddressElement) NonceRemove() *AddressElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	AddressPopoverAuto AddressPopoverChoice = "auto"
	// Popovers that have the auto state can be "light dismissed" by selecting
	// outside the popover area, and generally only allow one popover to be
	// displayed on-screen at a time.
	AddressPopoverEmpty AddressPopoverChoice = ""
	// manual popovers must always be explicitly hidden, but allow for use cases
	// such as nested popovers in menus.
	AddressPopoverManual AddressPopoverChoice = "manual"
)
...
func (e *AddressElement) PopoverRemove() *AddressElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *AddressElement) RoleRemove() *AddressElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *AddressElement) SlotRemove() *AddressElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	AddressSpellcheckEmpty AddressSpellcheckChoice = ""
	// The element will be checked for spelling errors.
	AddressSpellcheckTrue AddressSpellcheckChoice = "true"
	// The element will not be checked for spelling errors.
	AddressSpellcheckFalse AddressSpellcheckChoice = "false"
)
...
func (e *AddressElement) SpellcheckRemove() *AddressElement {
	if e.stringAttributes == nil {
		return e
	}
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *AddressElement) IfStyle(condition bool, s string) *AddressElement {
	if condition {
		e.Style(s)
	}
	return e
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *AddressElement) StyleAdd(k string, v string) *AddressElement {
	if e.keyValueStrings == nil {
		e.keyValueStrings = treemap.New[string, *keyValueBuilder]()
	}
	_, ok := e.keyValueStrings.Get("style")
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *AddressElement) IfStyleAdd(condition bool, k string, v string) *AddressElement {
	if condition {
		e.StyleAdd(k, v)
	}
	return e
...
func (e *AddressElement) TabindexRemove() *AddressElement {
	if e.intAttributes == nil {
		return e
	}
...
func (e *AddressElement) TitleRemove() *AddressElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	AddressTranslateEmpty AddressTranslateChoice = ""
	// indicates that the element should be translated when the page is localized.
	AddressTranslateYes AddressTranslateChoice = "yes"
	// indicates that the element must not be translated when the page is localized.
	AddressTranslateNo AddressTranslateChoice = "no"
)
...
func (e *AddressElement) TranslateRemove() *AddressElement {
	if e.stringAttributes == nil {
		return e
	}
