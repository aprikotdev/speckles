...
// Package elements html span is generated from configuration file.
package elements
...
// Create a new SpanElement element. This will create a new element
// with the tag "span" during rendering.
...
func (e *SpanElement) Attr(name, value string) *SpanElement {
...
const (
	...
	SpanAutocapitalizeOff SpanAutocapitalizeChoice = "off"
	// Do not automatically capitalize any text.
	SpanAutocapitalizeNone SpanAutocapitalizeChoice = "none"
	// Automatically capitalize the first character of each sentence.
	SpanAutocapitalizeSentences SpanAutocapitalizeChoice = "sentences"
	// Automatically capitalize the first character of each sentence.
	SpanAutocapitalizeOn SpanAutocapitalizeChoice = "on"
	// Automatically capitalize the first character of each word.
	SpanAutocapitalizeWords SpanAutocapitalizeChoice = "words"
	// Automatically capitalize all characters.
	SpanAutocapitalizeCharacters SpanAutocapitalizeChoice = "characters"
)
...
func (e *SpanElement) AutocapitalizeRemove() *SpanElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	SpanContenteditableEmpty SpanContenteditableChoice = ""
	// The element is editable.
	SpanContenteditableTrue SpanContenteditableChoice = "true"
	// The element is not editable.
	SpanContenteditableFalse SpanContenteditableChoice = "false"
	// which indicates that the element's raw text is editable, but rich text
	// formatting is disabled.
	SpanContenteditablePlaintextOnly SpanContenteditableChoice = "plaintext-only"
)
...
func (e *SpanElement) ContenteditableRemove() *SpanElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	SpanDirAuto SpanDirChoice = "auto"
)
...
func (e *SpanElement) DirRemove() *SpanElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	SpanDraggableTrue SpanDraggableChoice = "true"
	// The element is not draggable.
	SpanDraggableFalse SpanDraggableChoice = "false"
	...
	SpanDraggableEmpty SpanDraggableChoice = ""
	// drag behavior is the default browser behavior: only text selections, images,
	// and links can be dragged. For other elements, the event ondragstart must be
	// set for drag and drop to work
	SpanDraggableAuto SpanDraggableChoice = "auto"
)
...
func (e *SpanElement) DraggableRemove() *SpanElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	SpanHiddenEmpty SpanHiddenChoice = ""
	// set the element to the hidden state. Additionally, invalid values set the
	// element to the hidden state.
	SpanHiddenHidden SpanHiddenChoice = "hidden"
	...
	//
	SpanHiddenUntilFound SpanHiddenChoice = "until-found"
)
...
func (e *SpanElement) HiddenRemove() *SpanElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *SpanElement) IDRemove() *SpanElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	// control.
	SpanInputmodeNone SpanInputmodeChoice = "none"
	// Standard input keyboard for the user's current locale.
	SpanInputmodeEmpty SpanInputmodeChoice = ""
	// Standard input keyboard for the user's current locale.
	SpanInputmodeText SpanInputmodeChoice = "text"
	...
	// key (-).
	SpanInputmodeDecimal SpanInputmodeChoice = "decimal"
	// Numeric input keyboard, but only requires the digits 0–9. Devices may or
	// may not show a minus key.
	SpanInputmodeNumeric SpanInputmodeChoice = "numeric"
	...
	SpanInputmodeTel SpanInputmodeChoice = "tel"
	...
	// type="search"> instead.
	SpanInputmodeSearch SpanInputmodeChoice = "search"
	...
	SpanInputmodeEmail SpanInputmodeChoice = "email"
	...
	SpanInputmodeURL SpanInputmodeChoice = "url"
)
...
func (e *SpanElement) InputmodeRemove() *SpanElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *SpanElement) IsRemove() *SpanElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *SpanElement) ItemidRemove() *SpanElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *SpanElement) ItempropRemove() *SpanElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *SpanElement) ItemrefRemove() *SpanElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *SpanElement) ItemtypeRemove() *SpanElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *SpanElement) LangRemove() *SpanElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *SpanElement) NonceRemove() *SpanElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	SpanPopoverAuto SpanPopoverChoice = "auto"
	// Popovers that have the auto state can be "light dismissed" by selecting
	// outside the popover area, and generally only allow one popover to be
	// displayed on-screen at a time.
	SpanPopoverEmpty SpanPopoverChoice = ""
	// manual popovers must always be explicitly hidden, but allow for use cases
	// such as nested popovers in menus.
	SpanPopoverManual SpanPopoverChoice = "manual"
)
...
func (e *SpanElement) PopoverRemove() *SpanElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *SpanElement) RoleRemove() *SpanElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *SpanElement) SlotRemove() *SpanElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	SpanSpellcheckEmpty SpanSpellcheckChoice = ""
	// The element will be checked for spelling errors.
	SpanSpellcheckTrue SpanSpellcheckChoice = "true"
	// The element will not be checked for spelling errors.
	SpanSpellcheckFalse SpanSpellcheckChoice = "false"
)
...
func (e *SpanElement) SpellcheckRemove() *SpanElement {
	if e.stringAttributes == nil {
		return e
	}
...
// The style global attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *SpanElement) IfStyle(condition bool, s string) *SpanElement {
	if condition {
		e.Style(s)
	}
	return e
...
// The style global attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *SpanElement) StyleAdd(k string, v string) *SpanElement {
	if e.keyValueStrings == nil {
		e.keyValueStrings = treemap.New[string, *keyValueBuilder]()
	}
	_, ok := e.keyValueStrings.Get("style")
...
// The style global attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *SpanElement) IfStyleAdd(condition bool, k string, v string) *SpanElement {
	if condition {
		e.StyleAdd(k, v)
	}
	return e
...
func (e *SpanElement) TabindexRemove() *SpanElement {
	if e.intAttributes == nil {
		return e
	}
...
func (e *SpanElement) TitleRemove() *SpanElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	SpanTranslateEmpty SpanTranslateChoice = ""
	// indicates that the element should be translated when the page is localized.
	SpanTranslateYes SpanTranslateChoice = "yes"
	// indicates that the element must not be translated when the page is localized.
	SpanTranslateNo SpanTranslateChoice = "no"
)
...
func (e *SpanElement) TranslateRemove() *SpanElement {
	if e.stringAttributes == nil {
		return e
	}
