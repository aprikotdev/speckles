...
// Package elements html img is generated from configuration file.
package elements
...
// Create a new ImgElement element. This will create a new element
...
const (
	...
	ImgCrossoriginEmpty ImgCrossoriginChoice = ""
	// Anonymous usage. Send no cookies and no TLS certificate (if applicable).
	ImgCrossoriginAnonymous ImgCrossoriginChoice = "anonymous"
	// Send cookies and a TLS certificate (if applicable).
	ImgCrossoriginUseCredentials ImgCrossoriginChoice = "use-credentials"
)
...
const (
	...
	ImgLoadingAuto ImgLoadingChoice = "auto"
	// Hint to the browser that the image should be loaded immediately.
	ImgLoadingEager ImgLoadingChoice = "eager"
	// Hint to the browser that the image can be loaded lazily, after the rest of
	// the page content is loaded.
	ImgLoadingLazy ImgLoadingChoice = "lazy"
)
...
const (
	...
	ImgReferrerpolicyNoReferrer ImgReferrerpolicyChoice = "no-referrer"
	// The Referer header will not be sent to origins without TLS (HTTPS).
	ImgReferrerpolicyNoReferrerWhenDowngrade ImgReferrerpolicyChoice = "no-referrer-when-downgrade"
	// The Referer header will be the origin of the page.
	ImgReferrerpolicyOrigin ImgReferrerpolicyChoice = "origin"
	// The Referer header will be the origin of the page for same-origin requests,
	// and the full URL for cross-origin requests.
	ImgReferrerpolicyOriginWhenCrossOrigin ImgReferrerpolicyChoice = "origin-when-cross-origin"
	// The Referer header will be sent for same-origin requests, but cross-origin
	// requests will contain no Referer header.
	ImgReferrerpolicySameOrigin ImgReferrerpolicyChoice = "same-origin"
	// The Referer header will be sent with same-origin requests, but cross-origin
	// requests will contain no Referer header.
	ImgReferrerpolicyStrictOrigin ImgReferrerpolicyChoice = "strict-origin"
...
const (
	...
	ImgAutocapitalizeOff ImgAutocapitalizeChoice = "off"
	// Do not automatically capitalize any text.
	ImgAutocapitalizeNone ImgAutocapitalizeChoice = "none"
	// Automatically capitalize the first character of each sentence.
	ImgAutocapitalizeSentences ImgAutocapitalizeChoice = "sentences"
	// Automatically capitalize the first character of each sentence.
	ImgAutocapitalizeOn ImgAutocapitalizeChoice = "on"
	// Automatically capitalize the first character of each word.
	ImgAutocapitalizeWords ImgAutocapitalizeChoice = "words"
	// Automatically capitalize all characters.
	ImgAutocapitalizeCharacters ImgAutocapitalizeChoice = "characters"
)
...
const (
	...
	ImgContenteditableEmpty ImgContenteditableChoice = ""
	// The element is editable.
	ImgContenteditableTrue ImgContenteditableChoice = "true"
	// The element is not editable.
	ImgContenteditableFalse ImgContenteditableChoice = "false"
	// which indicates that the element's raw text is editable, but rich text
	// formatting is disabled.
	ImgContenteditablePlaintextOnly ImgContenteditableChoice = "plaintext-only"
)
...
const (
	...
	ImgDraggableTrue ImgDraggableChoice = "true"
	// The element is not draggable.
	ImgDraggableFalse ImgDraggableChoice = "false"
	...
	ImgDraggableEmpty ImgDraggableChoice = ""
	// drag behavior is the default browser behavior: only text selections, images,
	// and links can be dragged. For other elements, the event ondragstart must be
	// set for drag and drop to work
	ImgDraggableAuto ImgDraggableChoice = "auto"
)
...
const (
	...
	ImgHiddenEmpty ImgHiddenChoice = ""
	// set the element to the hidden state. Additionally, invalid values set the
	// element to the hidden state.
	ImgHiddenHidden ImgHiddenChoice = "hidden"
	...
	//
	ImgHiddenUntilFound ImgHiddenChoice = "until-found"
)
...
const (
	...
	// control.
	ImgInputmodeNone ImgInputmodeChoice = "none"
	// Standard input keyboard for the user's current locale.
	ImgInputmodeEmpty ImgInputmodeChoice = ""
	// Standard input keyboard for the user's current locale.
	ImgInputmodeText ImgInputmodeChoice = "text"
	...
	ImgInputmodeTel ImgInputmodeChoice = "tel"
	...
	// type="search"> instead.
	ImgInputmodeSearch ImgInputmodeChoice = "search"
	...
	ImgInputmodeEmail ImgInputmodeChoice = "email"
	...
	ImgInputmodeURL ImgInputmodeChoice = "url"
)
...
const (
	...
	ImgPopoverAuto ImgPopoverChoice = "auto"
	// Popovers that have the auto state can be "light dismissed" by selecting
	// outside the popover area, and generally only allow one popover to be
	// displayed on-screen at a time.
	ImgPopoverEmpty ImgPopoverChoice = ""
	// manual popovers must always be explicitly hidden, but allow for use cases
	// such as nested popovers in menus.
	ImgPopoverManual ImgPopoverChoice = "manual"
)
...
const (
	...
	ImgSpellcheckEmpty ImgSpellcheckChoice = ""
	// The element will be checked for spelling errors.
	ImgSpellcheckTrue ImgSpellcheckChoice = "true"
	// The element will not be checked for spelling errors.
	ImgSpellcheckFalse ImgSpellcheckChoice = "false"
)
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *ImgElement) IfStyle(condition bool, s string) *ImgElement {
	if condition {
		e.Style(s)
	}
	return e
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *ImgElement) IfStyleAdd(condition bool, k string, v string) *ImgElement {
	if condition {
		e.StyleAdd(k, v)
	}
	return e
...
const (
	...
	ImgTranslateEmpty ImgTranslateChoice = ""
	// indicates that the element should be translated when the page is localized.
	ImgTranslateYes ImgTranslateChoice = "yes"
	// indicates that the element must not be translated when the page is localized.
	ImgTranslateNo ImgTranslateChoice = "no"
)
