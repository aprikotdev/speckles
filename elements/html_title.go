...
// Package elements html title is generated from configuration file.
package elements
...
// Create a new TitleElement element. This will create a new element
...
func (e *TitleElement) BoolAttr(name string) *TitleElement {
...
func (e *TitleElement) BoolAttrRemove(name string) *TitleElement {
	if e.boolAttributes == nil {
		return e
	}
...
func (e *TitleElement) IfBoolAttr(condition bool, name string) *TitleElement {
	if condition {
		e.BoolAttr(name)
	}
	return e
...
func (e *TitleElement) BoolAttrf(format string, args ...any) *TitleElement {
	return e.BoolAttr(fmt.Sprintf(format, args...))
}

func (e *TitleElement) IfBoolAttrf(condition bool, format string, args ...any) *TitleElement {
	if condition {
...
func (e *TitleElement) BoolAttrs(names ...string) *TitleElement {
...
func (e *TitleElement) IfBoolAttrs(condition bool, names ...string) *TitleElement {
	if condition {
		e.BoolAttrs(names...)
	}
	return e
...
func (e *TitleElement) Attr(name, value string) *TitleElement {
...
func (e *TitleElement) IfAttr(condition bool, name, value string) *TitleElement {
	if condition {
		e.Attr(name, value)
	}
	return e
...
func (e *TitleElement) Attrf(name, format string, args ...any) *TitleElement {
	return e.Attr(name, fmt.Sprintf(format, args...))
}

func (e *TitleElement) IfAttrf(condition bool, name, format string, args ...any) *TitleElement {
	if condition {
...
func (e *TitleElement) IfAttrs(condition bool, attrs ...string) *TitleElement {
	if condition {
		e.Attrs(attrs...)
	}
	return e
...
func (e *TitleElement) IfAttrsMap(condition bool, attrs map[string]string) *TitleElement {
	if condition {
		e.AttrsMap(attrs)
	}
	return e
...
const (
	...
	TitleAutocapitalizeOff TitleAutocapitalizeChoice = "off"
	// Do not automatically capitalize any text.
	TitleAutocapitalizeNone TitleAutocapitalizeChoice = "none"
	// Automatically capitalize the first character of each sentence.
	TitleAutocapitalizeSentences TitleAutocapitalizeChoice = "sentences"
	// Automatically capitalize the first character of each sentence.
	TitleAutocapitalizeOn TitleAutocapitalizeChoice = "on"
	// Automatically capitalize the first character of each word.
	TitleAutocapitalizeWords TitleAutocapitalizeChoice = "words"
	// Automatically capitalize all characters.
	TitleAutocapitalizeCharacters TitleAutocapitalizeChoice = "characters"
)
...
func (e *TitleElement) AutocapitalizeRemove() *TitleElement {
	if e.stringAttributes == nil {
		return e
	}
...
// label, and the sighted user on a small device will equally miss the context
// created by the preceding content.
func (e *TitleElement) AutofocusRemove() *TitleElement {
	if e.boolAttributes == nil {
		return e
	}
...
// label, and the sighted user on a small device will equally miss the context
// created by the preceding content.
func (e *TitleElement) AutofocusIfRemove() *TitleElement {
	if e.boolAttributes == nil {
		return e
	}
	e.boolAttributes.Del("autofocus")
...
const (
	...
	TitleContenteditableEmpty TitleContenteditableChoice = ""
	// The element is editable.
	TitleContenteditableTrue TitleContenteditableChoice = "true"
	// The element is not editable.
	TitleContenteditableFalse TitleContenteditableChoice = "false"
	// which indicates that the element's raw text is editable, but rich text
	// formatting is disabled.
	TitleContenteditablePlaintextOnly TitleContenteditableChoice = "plaintext-only"
)
...
func (e *TitleElement) ContenteditableRemove() *TitleElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	TitleDirAuto TitleDirChoice = "auto"
)
...
func (e *TitleElement) DirRemove() *TitleElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	TitleDraggableTrue TitleDraggableChoice = "true"
	// The element is not draggable.
	TitleDraggableFalse TitleDraggableChoice = "false"
	...
	TitleDraggableEmpty TitleDraggableChoice = ""
	// drag behavior is the default browser behavior: only text selections, images,
	// and links can be dragged. For other elements, the event ondragstart must be
	// set for drag and drop to work
	TitleDraggableAuto TitleDraggableChoice = "auto"
)
...
func (e *TitleElement) DraggableRemove() *TitleElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	TitleHiddenEmpty TitleHiddenChoice = ""
	// set the element to the hidden state. Additionally, invalid values set the
	// element to the hidden state.
	TitleHiddenHidden TitleHiddenChoice = "hidden"
	...
	//
	TitleHiddenUntilFound TitleHiddenChoice = "until-found"
)
...
func (e *TitleElement) HiddenRemove() *TitleElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *TitleElement) IDRemove() *TitleElement {
	if e.stringAttributes == nil {
		return e
	}
...
// focus. Hides the element and its content from assistive technologies by
// excluding them from the accessibility tree.
func (e *TitleElement) InertRemove() *TitleElement {
	if e.boolAttributes == nil {
		return e
	}
...
// focus. Hides the element and its content from assistive technologies by
// excluding them from the accessibility tree.
func (e *TitleElement) InertIfRemove() *TitleElement {
	if e.boolAttributes == nil {
		return e
	}
	e.boolAttributes.Del("inert")
...
const (
	...
	// control.
	TitleInputmodeNone TitleInputmodeChoice = "none"
	// Standard input keyboard for the user's current locale.
	TitleInputmodeEmpty TitleInputmodeChoice = ""
	// Standard input keyboard for the user's current locale.
	TitleInputmodeText TitleInputmodeChoice = "text"
	...
	// key (-).
	TitleInputmodeDecimal TitleInputmodeChoice = "decimal"
	// Numeric input keyboard, but only requires the digits 0–9. Devices may or
	// may not show a minus key.
	TitleInputmodeNumeric TitleInputmodeChoice = "numeric"
	...
	TitleInputmodeTel TitleInputmodeChoice = "tel"
	...
	// type="search"> instead.
	TitleInputmodeSearch TitleInputmodeChoice = "search"
	...
	TitleInputmodeEmail TitleInputmodeChoice = "email"
	...
	TitleInputmodeURL TitleInputmodeChoice = "url"
)
...
func (e *TitleElement) InputmodeRemove() *TitleElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *TitleElement) IsRemove() *TitleElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *TitleElement) ItemidRemove() *TitleElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *TitleElement) ItempropRemove() *TitleElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *TitleElement) ItemrefRemove() *TitleElement {
	if e.stringAttributes == nil {
		return e
	}
...
// range of elements including <audio>, <embed>, <iframe>, <img>, <link>,
// <object>, <source>, <track>, and <video>.
func (e *TitleElement) ItemscopeRemove() *TitleElement {
	if e.boolAttributes == nil {
		return e
	}
...
// range of elements including <audio>, <embed>, <iframe>, <img>, <link>,
// <object>, <source>, <track>, and <video>.
func (e *TitleElement) ItemscopeIfRemove() *TitleElement {
	if e.boolAttributes == nil {
		return e
	}
	e.boolAttributes.Del("itemscope")
...
func (e *TitleElement) ItemtypeRemove() *TitleElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *TitleElement) LangRemove() *TitleElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *TitleElement) NonceRemove() *TitleElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	TitlePopoverAuto TitlePopoverChoice = "auto"
	// Popovers that have the auto state can be "light dismissed" by selecting
	// outside the popover area, and generally only allow one popover to be
	// displayed on-screen at a time.
	TitlePopoverEmpty TitlePopoverChoice = ""
	// manual popovers must always be explicitly hidden, but allow for use cases
	// such as nested popovers in menus.
	TitlePopoverManual TitlePopoverChoice = "manual"
)
...
func (e *TitleElement) PopoverRemove() *TitleElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *TitleElement) RoleRemove() *TitleElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *TitleElement) SlotRemove() *TitleElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	TitleSpellcheckEmpty TitleSpellcheckChoice = ""
	// The element will be checked for spelling errors.
	TitleSpellcheckTrue TitleSpellcheckChoice = "true"
	// The element will not be checked for spelling errors.
	TitleSpellcheckFalse TitleSpellcheckChoice = "false"
)
...
func (e *TitleElement) SpellcheckRemove() *TitleElement {
	if e.stringAttributes == nil {
		return e
	}
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *TitleElement) IfStyle(condition bool, s string) *TitleElement {
	if condition {
		e.Style(s)
	}
	return e
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *TitleElement) StyleAdd(k string, v string) *TitleElement {
	if e.keyValueStrings == nil {
		e.keyValueStrings = treemap.New[string, *keyValueBuilder]()
	}
	_, ok := e.keyValueStrings.Get("style")
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *TitleElement) StyleAddf(k string, format string, args ...any) *TitleElement {
	return e.StyleAdd(k, fmt.Sprintf(format, args...))
}

// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *TitleElement) IfStyleAdd(condition bool, k string, v string) *TitleElement {
	if condition {
		e.StyleAdd(k, v)
	}
	return e
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *TitleElement) IfStyleAddf(condition bool, k string, format string, args ...any) *TitleElement {
	if condition {
...
func (e *TitleElement) TabindexRemove() *TitleElement {
	if e.intAttributes == nil {
		return e
	}
...
func (e *TitleElement) TitleRemove() *TitleElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	TitleTranslateEmpty TitleTranslateChoice = ""
	// indicates that the element should be translated when the page is localized.
	TitleTranslateYes TitleTranslateChoice = "yes"
	// indicates that the element must not be translated when the page is localized.
	TitleTranslateNo TitleTranslateChoice = "no"
)
...
func (e *TitleElement) TranslateRemove() *TitleElement {
	if e.stringAttributes == nil {
		return e
	}
