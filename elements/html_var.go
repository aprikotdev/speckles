...
// Package elements html var is generated from configuration file.
package elements
...
// The HTML <var> element represents a variable in a mathematical expression or
// a programming context.
type VarElement struct {
	*Element
}

// Create a new VarElement element. This will create a new element
// with the tag "var" during rendering.
...
func (e *VarElement) BoolAttr(name string) *VarElement {
...
func (e *VarElement) BoolAttrRemove(name string) *VarElement {
	if e.boolAttributes == nil {
		return e
	}
...
func (e *VarElement) BoolAttrf(format string, args ...any) *VarElement {
	return e.BoolAttr(fmt.Sprintf(format, args...))
}

func (e *VarElement) IfBoolAttrf(condition bool, format string, args ...any) *VarElement {
	if condition {
...
func (e *VarElement) BoolAttrs(names ...string) *VarElement {
...
func (e *VarElement) IfBoolAttrs(condition bool, names ...string) *VarElement {
	if condition {
		e.BoolAttrs(names...)
	}
	return e
...
func (e *VarElement) Attr(name, value string) *VarElement {
...
func (e *VarElement) IfAttr(condition bool, name, value string) *VarElement {
	if condition {
		e.Attr(name, value)
	}
	return e
...
func (e *VarElement) Attrf(name, format string, args ...any) *VarElement {
	return e.Attr(name, fmt.Sprintf(format, args...))
}

func (e *VarElement) IfAttrf(condition bool, name, format string, args ...any) *VarElement {
	if condition {
...
func (e *VarElement) IfAttrs(condition bool, attrs ...string) *VarElement {
	if condition {
		e.Attrs(attrs...)
	}
	return e
...
func (e *VarElement) IfAttrsMap(condition bool, attrs map[string]string) *VarElement {
	if condition {
		e.AttrsMap(attrs)
	}
	return e
...
const (
	...
	VarAutocapitalizeOff VarAutocapitalizeChoice = "off"
	// Do not automatically capitalize any text.
	VarAutocapitalizeNone VarAutocapitalizeChoice = "none"
	// Automatically capitalize the first character of each sentence.
	VarAutocapitalizeSentences VarAutocapitalizeChoice = "sentences"
	// Automatically capitalize the first character of each sentence.
	VarAutocapitalizeOn VarAutocapitalizeChoice = "on"
	// Automatically capitalize the first character of each word.
	VarAutocapitalizeWords VarAutocapitalizeChoice = "words"
	// Automatically capitalize all characters.
	VarAutocapitalizeCharacters VarAutocapitalizeChoice = "characters"
)
...
func (e *VarElement) AutocapitalizeRemove() *VarElement {
	if e.stringAttributes == nil {
		return e
	}
...
// label, and the sighted user on a small device will equally miss the context
// created by the preceding content.
func (e *VarElement) AutofocusRemove() *VarElement {
	if e.boolAttributes == nil {
		return e
	}
...
// label, and the sighted user on a small device will equally miss the context
// created by the preceding content.
func (e *VarElement) AutofocusIfRemove() *VarElement {
	if e.boolAttributes == nil {
		return e
	}
	e.boolAttributes.Del("autofocus")
...
const (
	...
	VarContenteditableEmpty VarContenteditableChoice = ""
	// The element is editable.
	VarContenteditableTrue VarContenteditableChoice = "true"
	// The element is not editable.
	VarContenteditableFalse VarContenteditableChoice = "false"
	// which indicates that the element's raw text is editable, but rich text
	// formatting is disabled.
	VarContenteditablePlaintextOnly VarContenteditableChoice = "plaintext-only"
)
...
func (e *VarElement) ContenteditableRemove() *VarElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *VarElement) DirRemove() *VarElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	VarDraggableTrue VarDraggableChoice = "true"
	// The element is not draggable.
	VarDraggableFalse VarDraggableChoice = "false"
	...
	VarDraggableEmpty VarDraggableChoice = ""
	// drag behavior is the default browser behavior: only text selections, images,
	// and links can be dragged. For other elements, the event ondragstart must be
	// set for drag and drop to work
	VarDraggableAuto VarDraggableChoice = "auto"
)
...
func (e *VarElement) DraggableRemove() *VarElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	VarHiddenEmpty VarHiddenChoice = ""
	// set the element to the hidden state. Additionally, invalid values set the
	// element to the hidden state.
	VarHiddenHidden VarHiddenChoice = "hidden"
	...
	//
	VarHiddenUntilFound VarHiddenChoice = "until-found"
)
...
func (e *VarElement) HiddenRemove() *VarElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *VarElement) IDRemove() *VarElement {
	if e.stringAttributes == nil {
		return e
	}
...
// focus. Hides the element and its content from assistive technologies by
// excluding them from the accessibility tree.
func (e *VarElement) InertRemove() *VarElement {
	if e.boolAttributes == nil {
		return e
	}
...
// focus. Hides the element and its content from assistive technologies by
// excluding them from the accessibility tree.
func (e *VarElement) InertIfRemove() *VarElement {
	if e.boolAttributes == nil {
		return e
	}
	e.boolAttributes.Del("inert")
...
const (
	...
	// control.
	VarInputmodeNone VarInputmodeChoice = "none"
	// Standard input keyboard for the user's current locale.
	VarInputmodeEmpty VarInputmodeChoice = ""
	// Standard input keyboard for the user's current locale.
	VarInputmodeText VarInputmodeChoice = "text"
	...
	VarInputmodeTel VarInputmodeChoice = "tel"
	...
	// type="search"> instead.
	VarInputmodeSearch VarInputmodeChoice = "search"
	...
	VarInputmodeEmail VarInputmodeChoice = "email"
	...
	VarInputmodeURL VarInputmodeChoice = "url"
)
...
func (e *VarElement) InputmodeRemove() *VarElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *VarElement) IsRemove() *VarElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *VarElement) ItemidRemove() *VarElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *VarElement) ItempropRemove() *VarElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *VarElement) ItemrefRemove() *VarElement {
	if e.stringAttributes == nil {
		return e
	}
...
// range of elements including <audio>, <embed>, <iframe>, <img>, <link>,
// <object>, <source>, <track>, and <video>.
func (e *VarElement) ItemscopeRemove() *VarElement {
	if e.boolAttributes == nil {
		return e
	}
...
// range of elements including <audio>, <embed>, <iframe>, <img>, <link>,
// <object>, <source>, <track>, and <video>.
func (e *VarElement) ItemscopeIfRemove() *VarElement {
	if e.boolAttributes == nil {
		return e
	}
	e.boolAttributes.Del("itemscope")
...
func (e *VarElement) ItemtypeRemove() *VarElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *VarElement) LangRemove() *VarElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *VarElement) NonceRemove() *VarElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	VarPopoverAuto VarPopoverChoice = "auto"
	// Popovers that have the auto state can be "light dismissed" by selecting
	// outside the popover area, and generally only allow one popover to be
	// displayed on-screen at a time.
	VarPopoverEmpty VarPopoverChoice = ""
	// manual popovers must always be explicitly hidden, but allow for use cases
	// such as nested popovers in menus.
	VarPopoverManual VarPopoverChoice = "manual"
)
...
func (e *VarElement) PopoverRemove() *VarElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *VarElement) RoleRemove() *VarElement {
	if e.stringAttributes == nil {
		return e
	}
...
func (e *VarElement) SlotRemove() *VarElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	VarSpellcheckEmpty VarSpellcheckChoice = ""
	// The element will be checked for spelling errors.
	VarSpellcheckTrue VarSpellcheckChoice = "true"
	// The element will not be checked for spelling errors.
	VarSpellcheckFalse VarSpellcheckChoice = "false"
)
...
func (e *VarElement) SpellcheckRemove() *VarElement {
	if e.stringAttributes == nil {
		return e
	}
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *VarElement) IfStyle(condition bool, s string) *VarElement {
	if condition {
		e.Style(s)
	}
	return e
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *VarElement) StyleAdd(k string, v string) *VarElement {
	if e.keyValueStrings == nil {
		e.keyValueStrings = treemap.New[string, *keyValueBuilder]()
	}
	_, ok := e.keyValueStrings.Get("style")
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *VarElement) StyleAddf(k string, format string, args ...any) *VarElement {
	return e.StyleAdd(k, fmt.Sprintf(format, args...))
}

// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *VarElement) IfStyleAdd(condition bool, k string, v string) *VarElement {
	if condition {
		e.StyleAdd(k, v)
	}
	return e
...
// The style global Attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *VarElement) IfStyleAddf(condition bool, k string, format string, args ...any) *VarElement {
	if condition {
...
func (e *VarElement) TabindexRemove() *VarElement {
	if e.intAttributes == nil {
		return e
	}
...
func (e *VarElement) TitleRemove() *VarElement {
	if e.stringAttributes == nil {
		return e
	}
...
const (
	...
	VarTranslateEmpty VarTranslateChoice = ""
	// indicates that the element should be translated when the page is localized.
	VarTranslateYes VarTranslateChoice = "yes"
	// indicates that the element must not be translated when the page is localized.
	VarTranslateNo VarTranslateChoice = "no"
)
...
func (e *VarElement) TranslateRemove() *VarElement {
	if e.stringAttributes == nil {
		return e
	}
