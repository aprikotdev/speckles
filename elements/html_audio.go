...
// Package elements html audio is generated from configuration file.
package elements
...
// Create a new AudioElement element. This will create a new element
...
const (
	...
	AudioPreloadNone AudioPreloadChoice = "none"
	// Hints to the browser that the author does not expect the user to need the
	// media resource, but that fetching the resource metadata (dimensions, first
	// frame, track list, duration, etc), is reasonable.
	AudioPreloadMetadata AudioPreloadChoice = "metadata"
	...
	AudioPreloadAuto AudioPreloadChoice = "auto"
)
...
const (
	...
	AudioAutocapitalizeOff AudioAutocapitalizeChoice = "off"
	// Do not automatically capitalize any text.
	AudioAutocapitalizeNone AudioAutocapitalizeChoice = "none"
	// Automatically capitalize the first character of each sentence.
	AudioAutocapitalizeSentences AudioAutocapitalizeChoice = "sentences"
	// Automatically capitalize the first character of each sentence.
	AudioAutocapitalizeOn AudioAutocapitalizeChoice = "on"
	// Automatically capitalize the first character of each word.
	AudioAutocapitalizeWords AudioAutocapitalizeChoice = "words"
	// Automatically capitalize all characters.
	AudioAutocapitalizeCharacters AudioAutocapitalizeChoice = "characters"
)
...
const (
	...
	AudioContenteditableEmpty AudioContenteditableChoice = ""
	// The element is editable.
	AudioContenteditableTrue AudioContenteditableChoice = "true"
	// The element is not editable.
	AudioContenteditableFalse AudioContenteditableChoice = "false"
	// which indicates that the element's raw text is editable, but rich text
	// formatting is disabled.
	AudioContenteditablePlaintextOnly AudioContenteditableChoice = "plaintext-only"
)
...
const (
	...
	AudioDirAuto AudioDirChoice = "auto"
)
...
const (
	...
	AudioDraggableTrue AudioDraggableChoice = "true"
	// The element is not draggable.
	AudioDraggableFalse AudioDraggableChoice = "false"
	...
	AudioDraggableEmpty AudioDraggableChoice = ""
	// drag behavior is the default browser behavior: only text selections, images,
	// and links can be dragged. For other elements, the event ondragstart must be
	// set for drag and drop to work
	AudioDraggableAuto AudioDraggableChoice = "auto"
)
...
const (
	...
	AudioHiddenEmpty AudioHiddenChoice = ""
	// set the element to the hidden state. Additionally, invalid values set the
	// element to the hidden state.
	AudioHiddenHidden AudioHiddenChoice = "hidden"
	...
	//
	AudioHiddenUntilFound AudioHiddenChoice = "until-found"
)
...
const (
	...
	// control.
	AudioInputmodeNone AudioInputmodeChoice = "none"
	// Standard input keyboard for the user's current locale.
	AudioInputmodeEmpty AudioInputmodeChoice = ""
	// Standard input keyboard for the user's current locale.
	AudioInputmodeText AudioInputmodeChoice = "text"
	...
	// key (-).
	AudioInputmodeDecimal AudioInputmodeChoice = "decimal"
	// Numeric input keyboard, but only requires the digits 0–9. Devices may or
	// may not show a minus key.
	AudioInputmodeNumeric AudioInputmodeChoice = "numeric"
	...
	AudioInputmodeTel AudioInputmodeChoice = "tel"
	...
	// type="search"> instead.
	AudioInputmodeSearch AudioInputmodeChoice = "search"
	...
	AudioInputmodeEmail AudioInputmodeChoice = "email"
	...
	AudioInputmodeURL AudioInputmodeChoice = "url"
)
...
const (
	...
	AudioPopoverAuto AudioPopoverChoice = "auto"
	// Popovers that have the auto state can be "light dismissed" by selecting
	// outside the popover area, and generally only allow one popover to be
	// displayed on-screen at a time.
	AudioPopoverEmpty AudioPopoverChoice = ""
	// manual popovers must always be explicitly hidden, but allow for use cases
	// such as nested popovers in menus.
	AudioPopoverManual AudioPopoverChoice = "manual"
)
...
const (
	...
	AudioSpellcheckEmpty AudioSpellcheckChoice = ""
	// The element will be checked for spelling errors.
	AudioSpellcheckTrue AudioSpellcheckChoice = "true"
	// The element will not be checked for spelling errors.
	AudioSpellcheckFalse AudioSpellcheckChoice = "false"
)
...
// The style global attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *AudioElement) IfStyle(condition bool, s string) *AudioElement {
	if condition {
		e.Style(s)
	}
	return e
...
// The style global attribute is used to add styles to an element, such as
// color, font, size, and more. Styles are written in CSS.
func (e *AudioElement) IfStyleAdd(condition bool, k string, v string) *AudioElement {
	if condition {
		e.StyleAdd(k, v)
	}
	return e
...
const (
	...
	AudioTranslateEmpty AudioTranslateChoice = ""
	// indicates that the element should be translated when the page is localized.
	AudioTranslateYes AudioTranslateChoice = "yes"
	// indicates that the element must not be translated when the page is localized.
	AudioTranslateNo AudioTranslateChoice = "no"
)
